<?php
/* Smarty version 5.4.1, created on 2025-03-13 07:50:27
  from 'file:__feeds_post.body.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67d28e436d5043_54225811',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ad3f9c72535ee5aa2a7b3508bb6fb6eed8d9b4f5' => 
    array (
...
function content_67d28e436d5043_54225811 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\laragon\\www\\Script\\content\\themes\\xngine\\templates';
if ($_smarty_tpl->getValue('_post')['for_subscriptions']) {?>
...
<?php }
if ($_smarty_tpl->getValue('_post')['is_paid']) {?>
...
<?php }
if ($_smarty_tpl->getValue('_post')['for_adult']) {?>
	<div class="text-danger text-opacity-75 fw-bold small mb-2 d-flex align-items-center gap-1">
		...
		<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Adult");?>
...
<div class="d-flex justify-content-between x_user_info post-header">
	<div class="d-flex position-relative mw-0">
		...
		<div class="post-avatar position-relative flex-0">
			...
			<?php } else { ?>
				<a class="post-avatar-picture rounded-circle overflow-hidden d-block" href="<?php echo $_smarty_tpl->getValue('_post')['post_author_url'];?>
" style="background-image:url(<?php echo $_smarty_tpl->getValue('_post')['post_author_picture'];?>
);"></a>
				<?php if ($_smarty_tpl->getValue('_post')['post_author_online']) {?><span class="online-dot position-absolute rounded-circle"></span><?php }?>
			<?php }?>
		</div>
		<!-- post picture -->
		<div class="mw-0 mx-2">
			...
			<div class="post-meta">
				<!-- post author -->
				<?php if ($_smarty_tpl->getValue('_post')['is_anonymous']) {?>
					<span class="post-author fw-semibold"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Anonymous");?>
</span>
				<?php } else { ?>
...
">
						<a class="post-author fw-semibold body-color" href="<?php echo $_smarty_tpl->getValue('_post')['post_author_url'];?>
"><?php echo $_smarty_tpl->getValue('_post')['post_author_name'];?>
</a>
					</span>
					<?php if ($_smarty_tpl->getValue('_post')['post_author_verified']) {?>
						<span class="verified-badge" data-bs-toggle="tooltip" <?php if ($_smarty_tpl->getValue('_post')['user_type'] == "user") {?>title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Verified User");?>
'<?php } else { ?>title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Verified Page");?>
'<?php }?>>
...
'>
					...
					<?php }?>
					<?php if ($_smarty_tpl->getValue('_post')['user_type'] == "user") {?>
						<span class="text-muted small">@<?php echo $_smarty_tpl->getValue('_post')['user_name'];?>
</span>
					<?php }?>
					<?php if ($_smarty_tpl->getValue('_post')['user_type'] == "page") {?>
						<span class="text-muted small">@<?php echo $_smarty_tpl->getValue('_post')['page_name'];?>
</span>
					<?php }?>
				<?php }?>
				<!-- post author -->
...
"><?php echo $_smarty_tpl->getValue('_post')['album']['title'];?>
 ...
 <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("in");?>
 <a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/blogs/category/<?php echo $_smarty_tpl->getValue('_post')['blog']['category_id'];?>
/<?php echo $_smarty_tpl->getValue('_post')['blog']['category_url'];?>
"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')($_smarty_tpl->getValue('_post')['blog']['category_name']);?>
</a>
 ...
 <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("in");?>
 <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')($_smarty_tpl->getValue('_post')['video']['category_name']);?>
...
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("is");?>
 ...
 <i class="twa twa-md twa-<?php echo $_smarty_tpl->getValue('_post')['feeling_icon'];?>
"></i>
					</span>
				<?php }?>
				<!-- post feeling -->
...
" class="js_moment text-muted" data-time="<?php echo $_smarty_tpl->getValue('_post')['time'];?>
"><?php echo $_smarty_tpl->getValue('_post')['time'];?>
</a>
					<?php if ($_smarty_tpl->getValue('_post')['location']) {?>
						<span class="fw-bold mx-1">·</span> <span><?php echo $_smarty_tpl->getValue('_post')['location'];?>
</span>
					<?php }?>
					<?php if ($_smarty_tpl->getValue('system')['post_translation_enabled']) {?>
						<span class="fw-bold mx-1">·</span> <span class="text-link js_translator"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Translate");?>
</span>
					<?php }?>
...
' data-value="public">
											<i class="fa fa-globe-americas flex-0"></i> <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Public");?>
...
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Shared with: Followers");
											...
											<i class="fa fa-user-friends flex-0"></i> <?php if ($_smarty_tpl->getValue('system')['friends_enabled']) {
...
' data-value="me">
											<i class="fa fa-user-lock flex-0"></i> <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Only Me");?>
...
' data-value="me">
						...
						<?php } else { ?>
							<?php if ($_smarty_tpl->getValue('_post')['privacy'] == "me") {?>
								<i class="fa fa-user-lock flex-0 privacy-icon" data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Shared with");?>
 <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Only Me");?>
'></i>
							<?php } elseif ($_smarty_tpl->getValue('_post')['privacy'] == "friends") {?>
								<i class="fa fa-user-friends flex-0 privacy-icon" data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Shared with");?>
...
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Followers");
							...
							<?php } elseif ($_smarty_tpl->getValue('_post')['privacy'] == "public") {?>
								<i class="fa fa-globe-americas flex-0 privacy-icon" data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Shared with");?>
 <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Public");?>
'></i>
							<?php } elseif ($_smarty_tpl->getValue('_post')['privacy'] == "custom") {?>
								<i class="fa fa-cog privacy-icon" data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Shared with");?>
...
'></i>
					...
					<?php if ($_smarty_tpl->getValue('system')['posts_reviews_enabled'] && $_smarty_tpl->getValue('post')['post_type'] != "product") {?>
						<?php if ($_smarty_tpl->getValue('_post')['post_rate']) {?>
							...
							<span class="fw-medium small"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('number_format')($_smarty_tpl->getValue('_post')['post_rate'],1);?>
</span>
						<?php }?>
					<?php }?>
				</div>
				...
				<?php if ($_smarty_tpl->getValue('_post')['manage_post']) {?>
					...
					<?php if ($_smarty_tpl->getValue('system')['packages_enabled'] && !$_smarty_tpl->getValue('_post')['in_group'] && !$_smarty_tpl->getValue('_post')['in_event']) {?>
						...
						<?php } else { ?>
							...
							<?php } else { ?>
								<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/packages" class="dropdown-item action">
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="currentColor" fill="none"><path d="M5.22576 11.3294L12.224 2.34651C12.7713 1.64397 13.7972 2.08124 13.7972 3.01707V9.96994C13.7972 10.5305 14.1995 10.985 14.6958 10.985H18.0996C18.8729 10.985 19.2851 12.0149 18.7742 12.6706L11.776 21.6535C11.2287 22.356 10.2028 21.9188 10.2028 20.9829V14.0301C10.2028 13.4695 9.80048 13.015 9.3042 13.015H5.90035C5.12711 13.015 4.71494 11.9851 5.22576 11.3294Z" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" /></svg>
									<span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Boost Post");?>
</span>
								</a>
...
" class="dropdown-item pointer action">
					...
					<?php } elseif ($_smarty_tpl->getValue('_post')['post_type'] == "product") {?>
						<div class="dropdown-item pointer action" data-toggle="modal" data-url="posts/product.php?do=edit&post_id=<?php echo $_smarty_tpl->getValue('_post')['post_id'];?>
">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="currentColor" fill="none"><path d="M16.9459 3.17305C17.5332 2.58578 17.8268 2.29215 18.1521 2.15173C18.6208 1.94942 19.1521 1.94942 19.6208 2.15173C19.946 2.29215 20.2397 2.58578 20.8269 3.17305C21.4142 3.76032 21.7079 4.05395 21.8483 4.37925C22.0506 4.8479 22.0506 5.37924 21.8483 5.84789C21.7079 6.17319 21.4142 6.46682 20.8269 7.05409L15.8054 12.0757C14.5682 13.3129 13.9496 13.9315 13.1748 14.298C12.4 14.6645 11.5294 14.7504 9.78823 14.9222L9 15L9.07778 14.2118C9.24958 12.4706 9.33549 11.6 9.70201 10.8252C10.0685 10.0504 10.6871 9.43183 11.9243 8.19464L16.9459 3.17305Z" stroke="currentColor" stroke-width="1.75" stroke-linejoin="round" /><path d="M6 15H3.75C2.7835 15 2 15.7835 2 16.75C2 17.7165 2.7835 18.5 3.75 18.5H13.25C14.2165 18.5 15 19.2835 15 20.25C15 21.2165 14.2165 22 13.25 22H11" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" /></svg>
					...
					<?php } elseif ($_smarty_tpl->getValue('_post')['post_type'] == "funding") {?>
						<div class="dropdown-item pointer action" data-toggle="modal" data-url="posts/funding.php?do=edit&post_id=<?php echo $_smarty_tpl->getValue('_post')['post_id'];?>
">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="currentColor" fill="none"><path d="M16.9459 3.17305C17.5332 2.58578 17.8268 2.29215 18.1521 2.15173C18.6208 1.94942 19.1521 1.94942 19.6208 2.15173C19.946 2.29215 20.2397 2.58578 20.8269 3.17305C21.4142 3.76032 21.7079 4.05395 21.8483 4.37925C22.0506 4.8479 22.0506 5.37924 21.8483 5.84789C21.7079 6.17319 21.4142 6.46682 20.8269 7.05409L15.8054 12.0757C14.5682 13.3129 13.9496 13.9315 13.1748 14.298C12.4 14.6645 11.5294 14.7504 9.78823 14.9222L9 15L9.07778 14.2118C9.24958 12.4706 9.33549 11.6 9.70201 10.8252C10.0685 10.0504 10.6871 9.43183 11.9243 8.19464L16.9459 3.17305Z" stroke="currentColor" stroke-width="1.75" stroke-linejoin="round" /><path d="M6 15H3.75C2.7835 15 2 15.7835 2 16.75C2 17.7165 2.7835 18.5 3.75 18.5H13.25C14.2165 18.5 15 19.2835 15 20.25C15 21.2165 14.2165 22 13.25 22H11" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" /></svg>
					...
					<?php } elseif ($_smarty_tpl->getValue('_post')['post_type'] == "offer") {?>
						<div class="dropdown-item pointer action" data-toggle="modal" data-url="posts/offer.php?do=edit&post_id=<?php echo $_smarty_tpl->getValue('_post')['post_id'];?>
">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="currentColor" fill="none"><path d="M16.9459 3.17305C17.5332 2.58578 17.8268 2.29215 18.1521 2.15173C18.6208 1.94942 19.1521 1.94942 19.6208 2.15173C19.946 2.29215 20.2397 2.58578 20.8269 3.17305C21.4142 3.76032 21.7079 4.05395 21.8483 4.37925C22.0506 4.8479 22.0506 5.37924 21.8483 5.84789C21.7079 6.17319 21.4142 6.46682 20.8269 7.05409L15.8054 12.0757C14.5682 13.3129 13.9496 13.9315 13.1748 14.298C12.4 14.6645 11.5294 14.7504 9.78823 14.9222L9 15L9.07778 14.2118C9.24958 12.4706 9.33549 11.6 9.70201 10.8252C10.0685 10.0504 10.6871 9.43183 11.9243 8.19464L16.9459 3.17305Z" stroke="currentColor" stroke-width="1.75" stroke-linejoin="round" /><path d="M6 15H3.75C2.7835 15 2 15.7835 2 16.75C2 17.7165 2.7835 18.5 3.75 18.5H13.25C14.2165 18.5 15 19.2835 15 20.25C15 21.2165 14.2165 22 13.25 22H11" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" /></svg>
					...
					<?php } elseif ($_smarty_tpl->getValue('_post')['post_type'] == "job") {?>
						<div class="dropdown-item pointer action" data-toggle="modal" data-url="posts/job.php?do=edit&post_id=<?php echo $_smarty_tpl->getValue('_post')['post_id'];?>
">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="currentColor" fill="none"><path d="M16.9459 3.17305C17.5332 2.58578 17.8268 2.29215 18.1521 2.15173C18.6208 1.94942 19.1521 1.94942 19.6208 2.15173C19.946 2.29215 20.2397 2.58578 20.8269 3.17305C21.4142 3.76032 21.7079 4.05395 21.8483 4.37925C22.0506 4.8479 22.0506 5.37924 21.8483 5.84789C21.7079 6.17319 21.4142 6.46682 20.8269 7.05409L15.8054 12.0757C14.5682 13.3129 13.9496 13.9315 13.1748 14.298C12.4 14.6645 11.5294 14.7504 9.78823 14.9222L9 15L9.07778 14.2118C9.24958 12.4706 9.33549 11.6 9.70201 10.8252C10.0685 10.0504 10.6871 9.43183 11.9243 8.19464L16.9459 3.17305Z" stroke="currentColor" stroke-width="1.75" stroke-linejoin="round" /><path d="M6 15H3.75C2.7835 15 2 15.7835 2 16.75C2 17.7165 2.7835 18.5 3.75 18.5H13.25C14.2165 18.5 15 19.2835 15 20.25C15 21.2165 14.2165 22 13.25 22H11" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" /></svg>
					...
					<?php } elseif ($_smarty_tpl->getValue('_post')['post_type'] == "course") {?>
						<div class="dropdown-item pointer action" data-toggle="modal" data-url="posts/course.php?do=edit&post_id=<?php echo $_smarty_tpl->getValue('_post')['post_id'];?>
">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="currentColor" fill="none"><path d="M16.9459 3.17305C17.5332 2.58578 17.8268 2.29215 18.1521 2.15173C18.6208 1.94942 19.1521 1.94942 19.6208 2.15173C19.946 2.29215 20.2397 2.58578 20.8269 3.17305C21.4142 3.76032 21.7079 4.05395 21.8483 4.37925C22.0506 4.8479 22.0506 5.37924 21.8483 5.84789C21.7079 6.17319 21.4142 6.46682 20.8269 7.05409L15.8054 12.0757C14.5682 13.3129 13.9496 13.9315 13.1748 14.298C12.4 14.6645 11.5294 14.7504 9.78823 14.9222L9 15L9.07778 14.2118C9.24958 12.4706 9.33549 11.6 9.70201 10.8252C10.0685 10.0504 10.6871 9.43183 11.9243 8.19464L16.9459 3.17305Z" stroke="currentColor" stroke-width="1.75" stroke-linejoin="round" /><path d="M6 15H3.75C2.7835 15 2 15.7835 2 16.75C2 17.7165 2.7835 18.5 3.75 18.5H13.25C14.2165 18.5 15 19.2835 15 20.25C15 21.2165 14.2165 22 13.25 22H11" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" /></svg>
				...
				<?php } else { ?>
					<?php if ($_smarty_tpl->getValue('_post')['user_type'] == "user" && !$_smarty_tpl->getValue('_post')['is_anonymous']) {?>
						<div class="dropdown-item pointer align-items-start js_hide-author" data-author-id="<?php echo $_smarty_tpl->getValue('_post')['user_id'];?>
...
echo $_smarty_tpl->getValue('_post')['user_firstname'];
					...
					<div class="dropdown-item pointer js_hide-post align-items-start">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="currentColor" fill="none"><path d="M19.439 15.439C20.3636 14.5212 21.0775 13.6091 21.544 12.955C21.848 12.5287 22 12.3155 22 12C22 11.6845 21.848 11.4713 21.544 11.045C20.1779 9.12944 16.6892 5 12 5C11.0922 5 10.2294 5.15476 9.41827 5.41827M6.74742 6.74742C4.73118 8.1072 3.24215 9.94266 2.45604 11.045C2.15201 11.4713 2 11.6845 2 12C2 12.3155 2.15201 12.5287 2.45604 12.955C3.8221 14.8706 7.31078 19 12 19C13.9908 19 15.7651 18.2557 17.2526 17.2526" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" /><path d="M9.85786 10C9.32783 10.53 9 11.2623 9 12.0711C9 13.6887 10.3113 15 11.9289 15C12.7377 15 13.47 14.6722 14 14.1421" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" /><path d="M3 3L21 21" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" /></svg>
						<div class="action">
							<div><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Hide this post");?>
</div>
							<div class="action-desc"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("See fewer posts like this");?>
</div>
						</div>
					</div>
					<div class="dropdown-item action pointer" data-toggle="modal" data-url="data/report.php?do=create&handle=post&id=<?php echo $_smarty_tpl->getValue('_post')['post_id'];?>
">
				...
				<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/posts/<?php echo $_smarty_tpl->getValue('_post')['post_id'];?>
" target="_blank" class="dropdown-item pointer action">
...
;">
				...
				<?php if (!$_smarty_tpl->getValue('_shared') && $_smarty_tpl->getValue('_post')['post_type'] == "shared" && $_smarty_tpl->getValue('_post')['origin']) {?>
					<div class="post-snippet mt-2 <?php if ($_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('_post')['origin']['post_type'],array('product','funding','job','course','poll'))) {
}?>">
						<?php if ($_smarty_tpl->getValue('_snippet')) {?>
							<div class="post-snippet-toggle p-2 text-link small text-center main fw-medium js_show-attachments"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Show Attachments");?>
</div>
						<?php }?>
					...
					<div class="mt-2">
						<div class="post-media">
							<?php if ($_smarty_tpl->getValue('_post')['link']['source_thumbnail']) {?>
								<a class="post-media-image d-block position-relative" href="<?php echo $_smarty_tpl->getValue('_post')['link']['source_url'];?>
" target="_blank" rel="nofollow">
									<img src="<?php echo $_smarty_tpl->getValue('_post')['link']['source_thumbnail'];?>
">
									<div class="source text-truncate text-white m-2 position-absolute"><?php echo $_smarty_tpl->getValue('_post')['link']['source_title'];?>
</div>
								</a>
							<?php }?>
							<div class="post-media-meta w-100 pt-1">
								<a class="title d-inline-block" href="<?php echo $_smarty_tpl->getValue('_post')['link']['source_url'];?>
" target="_blank" rel="nofollow"><?php echo $_smarty_tpl->getValue('_post')['link']['source_host'];?>
</a>
								<div class="text overflow-hidden text-muted"><?php echo $_smarty_tpl->getValue('_post')['link']['source_text'];?>
</div>
							</div>
						</div>
					</div>
				...
				<?php if ($_smarty_tpl->getValue('_post')['post_type'] == "media" && $_smarty_tpl->getValue('_post')['media']) {?>
					<div class="mt-2">
						<?php if ($_smarty_tpl->getValue('_post')['media']['source_type'] == "photo") {?>
							<div class="post-media">
								<a class="post-media-image d-block position-relative" href="<?php echo $_smarty_tpl->getValue('_post')['media']['source_url'];?>
" target="_blank" rel="nofollow">
									<img src="<?php echo $_smarty_tpl->getValue('_post')['media']['source_url'];?>
">
									<div class="source text-truncate text-white m-2 position-absolute"><?php echo $_smarty_tpl->getValue('_post')['media']['source_provider'];?>
</div>
								</a>
							</div>
						<?php } else { ?>
...
$_smarty_tpl->assign('_post', $_tmp_array, false, NULL);?>
									<div class="youtube-player position-relative overflow-hidden js_youtube-player" data-id="<?php echo $_smarty_tpl->getValue('_post')['media']['vidoe_id'];?>
">
										<img class="position-absolute w-100 m-auto d-block pointer" src="https://i.ytimg.com/vi/<?php echo $_smarty_tpl->getValue('_post')['media']['vidoe_id'];?>
/hqdefault.jpg">
...
" type="application/x-mpegURL">
					...
					<?php } else { ?>
						<div class="youtube-player position-relative overflow-hidden with-live js_lightbox-live mt-2">
							<img class="position-absolute w-100 m-auto d-block pointer" src="<?php echo $_smarty_tpl->getValue('system')['system_uploads'];?>
/<?php echo $_smarty_tpl->getValue('_post')['live']['video_thumbnail'];?>
">
...
"></iframe>
				...
				<?php if ($_smarty_tpl->getValue('_post')['post_type'] == "article" && $_smarty_tpl->getValue('_post')['blog']) {?>
					<div class="mt-2">
						<div class="post-media">
							<a class="post-media-image d-block position-relative" href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
...
');"></div>
									<?php } else { ?>
										<div class="image" style="background-image:url('<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/content/themes/<?php echo $_smarty_tpl->getValue('system')['theme'];?>
/images/blank_blog.png');"></div>
									<?php }?>
								</div>
								<div class="source text-truncate text-white m-2 position-absolute"><?php echo $_smarty_tpl->getValue('_post')['blog']['title'];?>
</div>
							</a>
							<div class="post-media-meta w-100 pt-1 d-none">
								<a class="text overflow-hidden text-muted d-inline-block" href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/blogs/<?php echo $_smarty_tpl->getValue('_post')['post_id'];?>
/<?php echo $_smarty_tpl->getValue('_post')['blog']['title_url'];?>
"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('truncate')($_smarty_tpl->getValue('_post')['blog']['text_snippet'],400);?>
</a>
							</div>
						</div>
					</div>
				...
				<?php if ($_smarty_tpl->getValue('_post')['post_type'] == "product" && $_smarty_tpl->getValue('_post')['product']) {?>
					<div class="post-product-container mt-2">
						<h3 class="headline-font"><?php echo $_smarty_tpl->getValue('_post')['product']['name'];?>
</h3>
						<h5 class="main <?php if ($_smarty_tpl->getValue('system')['posts_reviews_enabled']) {?>mb-0<?php }?>">
						...
						<?php if ($_smarty_tpl->getValue('system')['posts_reviews_enabled']) {?>
							<div class="d-inline-flex align-items-center gap-2 small mb-2 pointer" data-toggle="modal" data-url="posts/who_reviews.php?post_id=<?php echo $_smarty_tpl->getValue('post')['post_id'];?>
">
								<span class="review-stars small">
									<i class="fa fa-star <?php if ($_smarty_tpl->getValue('_post')['post_rate'] >= 1) {?>checked<?php }?>"></i>
									<i class="fa fa-star <?php if ($_smarty_tpl->getValue('_post')['post_rate'] >= 2) {?>checked<?php }?>"></i>
								...
								<span class=""><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('number_format')($_smarty_tpl->getValue('_post')['post_rate'],1);?>
							...
							<div class="mt-3 d-flex gap-3">
								<?php if ($_smarty_tpl->getValue('system')['market_shopping_cart_enabled']) {?>
									<?php if ($_smarty_tpl->getValue('_post')['product']['available'] && $_smarty_tpl->getValue('_post')['product']['quantity'] > 0) {?>
										<button type="button" class="btn btn-main flex-1 js_shopping-add-to-cart" data-id="<?php echo $_smarty_tpl->getValue('_post')['post_id'];?>
">
								...
								<?php if ($_smarty_tpl->getValue('system')['chat_enabled'] && $_smarty_tpl->getValue('_post')['user_type'] == 'user') {?>
									<button type="button" class="btn btn-gray flex-0 js_chat-start" data-uid="<?php echo $_smarty_tpl->getValue('_post')['author_id'];?>
...
" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Contact Seller");?>
'>
										...
										<?php if (!$_smarty_tpl->getValue('system')['market_shopping_cart_enabled']) {?>
											<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Contact Seller");?>
							...
							<div class="d-flex">
								<?php if ($_smarty_tpl->getValue('_post')['product']['available']) {?>
									<?php if ($_smarty_tpl->getValue('_post')['product']['quantity'] > 0) {?>
										<span class="text-success text-opacity-75"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("In stock");?>
</span>
									<?php } else { ?>
										<span class="text-danger"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Out of stock");?>
</span>
									<?php }?>
								<?php } else { ?>
									<span class="text-danger"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("SOLD");?>
</span>
								<?php }?>
				  
								<?php if ($_smarty_tpl->getValue('_post')['product']['is_digital']) {?>
									<span class="fw-bold mx-2">·</span><span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Digital");?>
</span>
								<?php }?>
								
								<?php if ($_smarty_tpl->getValue('_post')['product']['status'] == "new") {?>
									<span class="fw-bold mx-2">·</span><span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("New");?>
</span>
								<?php } else { ?>
									<span class="fw-bold mx-2">·</span><span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Used");?>
</span>
								<?php }?>
							</div>
						</div>
...
" class="body-color"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')($_smarty_tpl->getValue('_post')['product']['category_name']);?>
</a>
						</div>
...
?>
									<?php if ($_smarty_tpl->getValue('custom_field')['value']) {?>
										<div>
											<div class="fw-medium"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')($_smarty_tpl->getValue('custom_field')['label']);?>
</div>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
				...
				<?php if ($_smarty_tpl->getValue('_post')['post_type'] == "funding" && $_smarty_tpl->getValue('_post')['funding']) {?>
					<div class="mt-2">
						<div class="post-media">
							<a class="post-media-image d-block position-relative ratio ratio-16x9" href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/posts/<?php echo $_smarty_tpl->getValue('_post')['post_id'];?>
" target="_blank">
								<div class="image" style="background-image:url('<?php echo $_smarty_tpl->getValue('system')['system_uploads'];?>
...
');"></div>
						...
						<div class="post-funding-meta mt-2">
							<h3 class="headline-font mb-1"><?php echo $_smarty_tpl->getValue('_post')['funding']['title'];?>
</h3>
...
?>
							...
							<?php if ($_smarty_tpl->getValue('user')->_logged_in && $_smarty_tpl->getValue('_post')['author_id'] != $_smarty_tpl->getValue('user')->_data['user_id']) {?>
								<div class="mt-3">
									<button type="button" class="btn btn-main w-100" data-toggle="modal" data-url="#funding-donate" data-options='{ "post_id": <?php echo $_smarty_tpl->getValue('_post')["post_id"];?>
 }'>
							...
							<div class="funding-completion mt-3 p-2 rounded-3">
								<div class="d-flex align-items-center justify-content-between gap-3">
									<div class="fw-medium"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('_post')['funding']['raised_amount']);?>
 ...
 <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('_post')['funding']['amount']);?>
									...
									<span class="flex-0 small"><?php echo $_smarty_tpl->getValue('_post')['funding']['funding_completion'];?>
%</span>
								</div>
								<div class="progress mt-2">
									<div class="progress-bar bg-success bg-opacity-75" role="progressbar" aria-valuenow="<?php echo $_smarty_tpl->getValue('_post')['funding']['funding_completion'];?>
...
?>
						...
						<h3 class="headline-font mt-2"><?php echo $_smarty_tpl->getValue('_post')['offer']['meta_title'];?>
</h3>
						<?php if ($_smarty_tpl->getValue('_post')['offer']['price']) {?>
							<h6 class="">
								<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("From");?>
 <span class="main"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('_post')['offer']['price']);?>
</span>
							</h6>
						<?php }?>
						<?php if ($_smarty_tpl->getValue('_post')['offer']['end_date']) {?>
							<h6 class="">
								<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Expires");?>
: <span class=""><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('date_format')($_smarty_tpl->getValue('_post')['offer']['end_date'],$_smarty_tpl->getValue('system')['system_date_format']);?>
</span>
							</h6>
						<?php }?>
						<!-- custom fileds -->
...
');"></div>
						...
						<div class="post-job-meta">
							<h3 class="headline-font mt-2"><?php echo $_smarty_tpl->getValue('_post')['job']['title'];?>
</h3>
							<h6 class="">
								<span class="main"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('_post')['job']['salary_minimum'],$_smarty_tpl->getValue('_post')['job']['salary_minimum_currency']['symbol'],$_smarty_tpl->getValue('_post')['job']['salary_minimum_currency']['dir']);?>
...
</span> / <?php echo $_smarty_tpl->getValue('_post')['job']['pay_salary_per_meta'];?>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
							...
							<div class="post-job-wrapper align-items-center flex-wrap d-flex p-2 rounded-3">
								...
								<div class="post-job-details p-1 text-center">
									...
									<div class="">
										<?php if ($_smarty_tpl->getValue('_post')['job']['available']) {?>
											<span class="badge bg-success small"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Open");?>
</span>
										<?php } else { ?>
											<span class="badge bg-danger small"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Closed");?>
</span>
										<?php }?>
									</div>
								</div>
							...
							<?php if ($_smarty_tpl->getValue('_post')['author_id'] == $_smarty_tpl->getValue('user')->_data['user_id']) {?>
								<div class="mt-3 mb-2">
								  <button type="button" class="btn btn-main w-100 js_job-apply" data-toggle="modal" data-size="large" data-url="posts/job.php?do=candidates&post_id=<?php echo $_smarty_tpl->getValue('_post')['post_id'];?>
" <?php if ($_smarty_tpl->getValue('_post')['job']['candidates_count'] == 0) {?>disabled<?php }?>>
										<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("View Candidates");?>
 (<?php echo $_smarty_tpl->getValue('_post')['job']['candidates_count'];?>
							...
							<?php if ($_smarty_tpl->getValue('user')->_logged_in && $_smarty_tpl->getValue('_post')['job']['available'] && $_smarty_tpl->getValue('_post')['author_id'] != $_smarty_tpl->getValue('user')->_data['user_id']) {?>
								<div class="mt-3 mb-2">
									<button type="button" class="btn btn-main w-100 js_job-apply" data-toggle="modal" data-size="large" data-url="posts/job.php?do=application&post_id=<?php echo $_smarty_tpl->getValue('_post')['post_id'];?>
">
...
');"></div>
						...
						<div class="post-course-meta">
							<h3 class="headline-font mt-2"><?php echo $_smarty_tpl->getValue('_post')['course']['title'];?>
</h3>
							<h6 class="">
								<span class="main"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('_post')['course']['fees'],$_smarty_tpl->getValue('_post')['course']['fees_currency']['symbol'],$_smarty_tpl->getValue('_post')['course']['fees_currency']['dir']);?>
</span>
							</h6>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
							...
							<?php if ($_smarty_tpl->getValue('_post')['author_id'] == $_smarty_tpl->getValue('user')->_data['user_id']) {?>
								<div class="mt-3 mb-2">
									<button type="button" class="btn btn-main w-100 js_course-enroll" data-toggle="modal" data-size="large" data-url="posts/course.php?do=candidates&post_id=<?php echo $_smarty_tpl->getValue('_post')['post_id'];?>
" <?php if ($_smarty_tpl->getValue('_post')['course']['candidates_count'] == 0) {?>disabled<?php }?>>
 ...
 (<?php echo $_smarty_tpl->getValue('_post')['course']['candidates_count'];?>
							...
							<?php if ($_smarty_tpl->getValue('user')->_logged_in && $_smarty_tpl->getValue('_post')['course']['available'] && $_smarty_tpl->getValue('_post')['author_id'] != $_smarty_tpl->getValue('user')->_data['user_id']) {?>
								<div class="mt-3 mb-2">
									<button type="button" class="btn btn-main w-100 js_course-enroll" data-toggle="modal" data-size="large" data-url="posts/course.php?do=application&post_id=<?php echo $_smarty_tpl->getValue('_post')['post_id'];?>
">
...
?>
				...
				<?php if ($_smarty_tpl->getValue('_post')['post_type'] == "poll" && $_smarty_tpl->getValue('_post')['poll']) {?>
					<div class="poll-options d-flex flex-column gap-2 mt-2" data-poll-votes="<?php echo $_smarty_tpl->getValue('_post')['poll']['votes'];?>
">
						<?php
...
?>
							<div class="d-flex align-items-center gap-2">
								<div class="poll-option flex-1 js_poll-vote" data-id="<?php echo $_smarty_tpl->getValue('option')['option_id'];?>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
				...
				<?php if ($_smarty_tpl->getValue('_post')['post_type'] == "reel" && $_smarty_tpl->getValue('_post')['reel']) {?>
					<div class="overflow-hidden post-video-reel vertical-reel mt-2">
						<video class="w-100 js_video-plyr" id="reel-<?php echo $_smarty_tpl->getValue('_post')['reel']['reel_id'];
if ($_smarty_tpl->getValue('pinned') || $_smarty_tpl->getValue('boosted')) {?>-<?php echo $_smarty_tpl->getValue('_post')['post_id'];
...
" type="video/mp4" size="2160">
				...
				<?php if (($_smarty_tpl->getValue('_post')['post_type'] == "video" || $_smarty_tpl->getValue('_post')['post_type'] == "combo") && $_smarty_tpl->getValue('_post')['video']) {?>
					<div class="overflow-hidden post-video-reel mt-2">
						<video class="w-100 js_video-plyr" id="video-<?php echo $_smarty_tpl->getValue('_post')['video']['video_id'];
if ($_smarty_tpl->getValue('pinned') || $_smarty_tpl->getValue('boosted')) {?>-<?php echo $_smarty_tpl->getValue('_post')['post_id'];
...
" type="video/mp4" size="2160">
				...
				<?php if (($_smarty_tpl->getValue('_post')['post_type'] == "audio" || $_smarty_tpl->getValue('_post')['post_type'] == "combo") && $_smarty_tpl->getValue('_post')['audio']) {?>
					<div class="mt-2 lh-1">
						<audio class="py-2 rounded-3 js_audio w-100" id="audio-<?php echo $_smarty_tpl->getValue('_post')['audio']['audio_id'];?>
...
" type="audio/mp3">
				...
				<?php if (($_smarty_tpl->getValue('_post')['post_type'] == "file" || $_smarty_tpl->getValue('_post')['post_type'] == "combo") && $_smarty_tpl->getValue('_post')['file']) {?>
					<div class="post-downloader d-flex align-items-center gap-3 rounded-3 p-3 mt-2">
						...
						<div class="info">
							<div class="fw-medium"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("File Type");?>
: <?php ob_start();
...
echo $_smarty_tpl->getSmarty()->getModifierCallback('get_extension')($_prefixVariable1);?>
							...
							<a class="btn btn-main btn-sm mt-1 text-no-underline" href="<?php echo $_smarty_tpl->getValue('system')['system_uploads'];?>
