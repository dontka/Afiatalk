<?php
/* Smarty version 5.4.1, created on 2025-03-13 07:47:35
  from 'file:_header.messages.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67d28d97bf6f96_56618361',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '89bea840a9d2cf8fd6e69abcdc458ff345094bb9' => 
    array (
...
function content_67d28d97bf6f96_56618361 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\laragon\\www\\Script\\content\\themes\\xngine\\templates';
?><div class="dropend js_live-messages">
	<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/messages" class="d-block py-1 body-color x_side_links <?php if ($_smarty_tpl->getValue('page') == "messages") {?>fw-semibold main<?php }?>">
		<div class="d-inline-flex align-items-center position-relative main_bg_half">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="27" height="27" color="currentColor" fill="none">
				<?php if ($_smarty_tpl->getValue('page') == "messages") {?>
			...
			<span class="counter rounded-pill position-absolute text-center pe-none <?php if ($_smarty_tpl->getValue('user')->_data['user_live_messages_counter'] == 0) {?>x-hidden<?php }?>">
				<?php echo $_smarty_tpl->getValue('user')->_data['user_live_messages_counter'];?>

			</span>
			<span class="text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Messages");?>
</span>
		</div>
	</a>
