<?php
/* Smarty version 5.4.1, created on 2025-03-13 07:50:01
  from 'file:_publisher.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67d28e29af4067_62154791',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8458d7307552760f42c4be6a8bc7529d10aff3f3' => 
    array (
      0 => '_publisher.tpl',
      1 => 1735565863,
      2 => 'file',
...
function content_67d28e29af4067_62154791 (\Smarty\Template $_smarty_tpl) {
...
if ($_smarty_tpl->getValue('user')->_data['can_publish_posts']) {?>
	<?php if ($_smarty_tpl->getValue('system')['verification_for_posts'] && !$_smarty_tpl->getValue('user')->_data['user_verified']) {?>
		<div class="px-3 side_item_list x_announcement">
			...
			<div class="text">
				<div class="fw-semibold text-danger"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Account Verification Required");?>
</div>
				<div class="mt-1 mb-2"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("To publish posts your account must be verified");?>
.</div>
				<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/settings/verification" class="btn btn-main"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Verify Now");?>
</a>
			</div>
		</div>
	<?php } else { ?>
		<div id="publisher-wapper<?php if ($_smarty_tpl->getValue('_modal_mode')) {?>-modal<?php }?>">
			...
			<div class="x-form bg-white publisher" data-handle="<?php echo $_smarty_tpl->getValue('_handle');?>
" <?php if ($_smarty_tpl->getValue('_id')) {?>data-id="<?php echo $_smarty_tpl->getValue('_id');?>
" <?php }?> <?php if ($_smarty_tpl->getValue('_modal_mode')) {?>data-modal-mode="true" <?php }?> id="publisher-box">
				...
				<div class="side_item_list px-3 pt-3">
					<div class="d-flex align-items-start justify-content-between x_user_info gap-10">
						<?php if ($_smarty_tpl->getValue('_handle') == "page" || $_smarty_tpl->getValue('_post_as_page')) {?>
							<img class="publisher-avatar rounded-circle position-relative flex-0" src="<?php echo $_smarty_tpl->getValue('_avatar');?>
">
						<?php } else { ?>
							<img class="publisher-avatar rounded-circle position-relative flex-0" src="<?php echo $_smarty_tpl->getValue('user')->_data['user_picture'];?>
">
						<?php }?>
						<div class="flex-1">
							<!-- privacy -->
										...
										<?php if ($_smarty_tpl->getValue('system')['default_privacy'] == "me") {?>
											<div class="btn-group js_publisher-privacy" data-value="me">
												<button type="button" class="btn btn-sm btn-gray px-2 d-inline-block dropdown-toggle" data-bs-toggle="dropdown" data-display="static">
													<i class="btn-group-icon fa fa-user-lock"></i>&nbsp;&nbsp;<span class="btn-group-text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Only Me");?>
</span>
												</button>
...
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Followers");
										...
										<?php } elseif ($_smarty_tpl->getValue('system')['default_privacy'] == "friends") {?>
											<div class="btn-group js_publisher-privacy" data-value="friends">
												<button type="button" class="btn btn-sm btn-gray px-2 d-inline-block dropdown-toggle" data-bs-toggle="dropdown" data-display="static">
													<i class="btn-group-icon fa fa-user-friends"></i>&nbsp;&nbsp;<span class="btn-group-text"><?php if ($_smarty_tpl->getValue('system')['friends_enabled']) {
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Friends");
} else {
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Followers");
}?></span>
...
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Followers");
										...
										<?php } else { ?>
											<div class="btn-group js_publisher-privacy" data-value="public">
												<button type="button" class="btn btn-sm btn-gray px-2 d-inline-block dropdown-toggle" data-bs-toggle="dropdown" data-display="static">
													<i class="btn-group-icon fa fa-globe-americas"></i>&nbsp;&nbsp;<span class="btn-group-text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Public");?>
</span>
												</button>
												<div class="dropdown-menu">
													<div class="dropdown-item pointer" data-value="public">
...
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Followers");
							...
							<div class="publisher-message position-relative">
								<div class="colored-text-wrapper">
									<textarea <?php if ($_smarty_tpl->getValue('_modal_mode')) {?>autofocus<?php }?> dir="auto" class="js_autosize js_mention js_publisher-scraper mt-2 w-100 p-0 border-0 bg-transparent" data-init-placeholder='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("What is on your mind? #Hashtag.. @Mention.. Link..");?>
...
'>
								...
								<div class="publisher-meta" data-meta="feelings">
									<div class="d-flex align-items-center gap-3 publisher-meta-feelings">
										<div class="main_bg_half position-relative pointer" id="feelings-menu-toggle" data-init-text='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("What are you doing?");?>
'><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("What are you doing?");?>
</div>
										<div id="feelings-data" style="display: none">
											<input type="text" class="py-0 px-1" placeholder='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("What are you doing?");?>
'>
...
?>
												<div class="feeling-item js_feelings-add dropdown-item pointer" data-action="<?php echo $_smarty_tpl->getValue('feeling')['action'];?>
...
">
													<div class="icon flex-0">
														<i class="twa m-0 align-middle twa-<?php echo $_smarty_tpl->getValue('feeling')['icon'];?>
"></i>
													</div>
													<div class="data">
...
?>
												<div class="feeling-item js_feelings-type dropdown-item pointer" data-type="<?php echo $_smarty_tpl->getValue('type')['action'];?>
" data-icon="<?php echo $_smarty_tpl->getValue('type')['icon'];?>
">
													<div class="icon flex-0">
														<i class="twa m-0 align-middle twa-<?php echo $_smarty_tpl->getValue('type')['icon'];?>
"></i>
													</div>
													<div class="data">
...
?>
										<div class="d-inline-block pointer rounded-circle p-0 colored-pattern-item js_publisher-pattern" onclick="$('.publisher-message.colored textarea').css('height', 'auto');" data-id="<?php echo $_smarty_tpl->getValue('pattern')['pattern_id'];?>
...
<span class="loading-dots"></span>
 ...
 <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Voice Notes");?>
										...
										<div class="btn btn-voice-stop btn-danger btn-sm js_voice-stop" style="display: none">
											<svg xmlns="http://www.w3.org/2000/svg" height="18" viewBox="0 0 24 24" width="18"><path fill="currentColor" d="M8 6h8c1.1 0 2 .9 2 2v8c0 1.1-.9 2-2 2H8c-1.1 0-2-.9-2-2V8c0-1.1.9-2 2-2z"></path></svg> <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Recording");?>
...
...'>
								...
								<div class="publisher-meta" data-meta="reel">
									<div class="d-flex align-items-center justify-content-between gap-3">
										<div class="d-flex align-items-center small fw-medium gap-1">
											<svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 24 24" width="20" class="flex-0"><path d="M0 0h24v24H0V0z" fill="none"/><path fill="#1bc3bb" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM9.29 16.29L5.7 12.7c-.39-.39-.39-1.02 0-1.41.39-.39 1.02-.39 1.41 0L10 14.17l6.88-6.88c.39-.39 1.02-.39 1.41 0 .39.39.39 1.02 0 1.41l-7.59 7.59c-.38.39-1.02.39-1.41 0z"/></svg> <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Reel uploaded successfully");?>
								...
								<div class="publisher-custom-thumbnail position-relative overflow-hidden pt-2 publisher-reel-custom-thumbnail">
									<small><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Custom Reel Thumbnail");?>
</small>
									<div class="x-image w-100 mt-1">
										<button type="button" class="close publisher-scraper-remover border-0 position-absolute rounded-circle text-white p-2 m-2 x-hidden js_x-image-remover" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Remove");?>
'>
								...
								<div class="publisher-meta" data-meta="video">
									<div class="d-flex align-items-center justify-content-between gap-3">
										<div class="d-flex align-items-center small fw-medium gap-1">
											<svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 24 24" width="20" class="flex-0"><path d="M0 0h24v24H0V0z" fill="none"/><path fill="#1bc3bb" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM9.29 16.29L5.7 12.7c-.39-.39-.39-1.02 0-1.41.39-.39 1.02-.39 1.41 0L10 14.17l6.88-6.88c.39-.39 1.02-.39 1.41 0 .39.39.39 1.02 0 1.41l-7.59 7.59c-.38.39-1.02.39-1.41 0z"/></svg> <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Video uploaded successfully");?>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
								...
								<div class="publisher-custom-thumbnail position-relative overflow-hidden pt-2 publisher-video-custom-thumbnail">
									<small><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Custom Video Thumbnail");?>
</small>
									<div class="x-image w-100 mt-1">
										<button type="button" class="close publisher-scraper-remover border-0 position-absolute rounded-circle text-white p-2 m-2 x-hidden js_x-image-remover" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Remove");?>
'>
								...
								<div class="publisher-meta" data-meta="audio">
									<div class="d-flex align-items-center justify-content-between gap-3">
										<div class="d-flex align-items-center small fw-medium gap-1">
											<svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 24 24" width="20" class="flex-0"><path d="M0 0h24v24H0V0z" fill="none"/><path fill="#1bc3bb" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM9.29 16.29L5.7 12.7c-.39-.39-.39-1.02 0-1.41.39-.39 1.02-.39 1.41 0L10 14.17l6.88-6.88c.39-.39 1.02-.39 1.41 0 .39.39.39 1.02 0 1.41l-7.59 7.59c-.38.39-1.02.39-1.41 0z"/></svg> <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Audio uploaded successfully");?>
								...
								<div class="publisher-meta" data-meta="file">
									<div class="d-flex align-items-center justify-content-between gap-3">
										<div class="d-flex align-items-center small fw-medium gap-1">
											<svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 24 24" width="20" class="flex-0"><path d="M0 0h24v24H0V0z" fill="none"/><path fill="#1bc3bb" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM9.29 16.29L5.7 12.7c-.39-.39-.39-1.02 0-1.41.39-.39 1.02-.39 1.41 0L10 14.17l6.88-6.88c.39-.39 1.02-.39 1.41 0 .39.39.39 1.02 0 1.41l-7.59 7.59c-.38.39-1.02.39-1.41 0z"/></svg> <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("File uploaded successfully");?>
								...
								<div class="d-flex align-items-center flex-wrap justify-content-between gap-10 side_item_list">
									...
									<div class="d-flex align-items-center flex-wrap publisher-tools-tabs">
										<?php if ($_smarty_tpl->getValue('user')->_data['can_add_colored_posts']) {?>
											<div class="publisher-tools-tab js_publisher-tab main position-relative rounded-circle main_bg_half p-2 pointer" data-tab="colored" data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Colored Posts");?>
'>
										...
										<?php if ($_smarty_tpl->getValue('user')->_data['can_add_reels']) {?>
											<div class="publisher-tools-tab attach overflow-hidden js_publisher-tab main position-relative rounded-circle main_bg_half p-2 pointer" data-tab="reel" data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Upload Reel");?>
'>
										...
										<?php if ($_smarty_tpl->getValue('user')->_data['can_add_gif_posts']) {?>
											<div class="publisher-tools-tab js_publisher-tab main position-relative rounded-circle main_bg_half p-1 pointer" data-tab="gif" data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("GIF");?>
'>
										...
										<?php if ($_smarty_tpl->getValue('user')->_data['can_add_activity_posts']) {?>
											<div class="publisher-tools-tab js_publisher-feelings main position-relative rounded-circle main_bg_half p-2 pointer" data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Feelings/Activity");?>
'>
										...
										<div class="dropdown">
											<div class="d-flex align-items-center pointer main x_pub_btn" type="button" data-bs-toggle="dropdown">
												...
												<span class="small fw-medium"><small><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("More");?>
</small></span>
											</div>
											<div class="dropdown-menu">
												<?php if (!$_smarty_tpl->getValue('_quick_mode')) {?>
													<?php if ($_smarty_tpl->getValue('user')->_data['can_go_live']) {?>
														<a class="publisher-tools-tab link js_publisher-tab dropdown-item pointer" data-tab="live" href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
...
if ($_smarty_tpl->getValue('_handle') == "event") {?>?event_id=<?php echo $_smarty_tpl->getValue('_id');
													...
													<?php if ($_smarty_tpl->getValue('user')->_data['can_write_blogs'] && $_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('_handle'),array('me','page','group','event'))) {?>
														<a class="publisher-tools-tab link js_publisher-tab dropdown-item pointer" data-tab="blog" href='<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
...
if ($_smarty_tpl->getValue('_handle') == "event") {?>&event=<?php echo $_smarty_tpl->getValue('_id');
										...
										<?php if ($_smarty_tpl->getValue('system')['adult_mode'] || ($_smarty_tpl->getValue('_handle') == "me" && $_smarty_tpl->getValue('user')->_data['can_add_anonymous_posts']) || ($_smarty_tpl->getValue('_handle') != "page" && $_smarty_tpl->getValue('user')->_data['can_receive_tip']) || ($_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('_handle'),array('me','page','group')) && $_smarty_tpl->getValue('_node_can_monetize_content') && $_smarty_tpl->getValue('_node_monetization_enabled') && $_smarty_tpl->getValue('_node_monetization_plans') > 0) || ($_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('_handle'),array('me','page','group','event')) && $_smarty_tpl->getValue('user')->_data['can_monetize_content'] && $_smarty_tpl->getValue('user')->_data['user_monetization_enabled'])) {?>
											<div class="d-flex align-items-center pointer main mx-2 x_pub_btn" type="button" onclick="$(this).toggleClass('active');$('.publisher').toggleClass('large-text');" data-bs-toggle="collapse" data-bs-target="#x_pub_options" aria-controls="x_pub_options" aria-expanded="false">
												...
												<span class="small fw-medium"><small><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Options");?>
</small></span>
											</div>
										<?php }?>
									</div>
												...
												<div class="x-hidden" id="paid-price-wrapper">
													<div class="d-flex mb-2 gap-3 x_pub_paid_post">
														<div class="set_desc flex-1 x-hidden" id="paid-text-wrapper">
															<label class="d-block fw-medium mb-2"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Description");?>
</label>
															<textarea class="form-control bg-transparent border-0 p-0" name="paid_post_text" rows="2" placeholder='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Paid Post Description");?>
'></textarea>
														</div>
														<div class="set_price flex-0">
															<label class="d-block fw-medium mb-2"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Price');?>
							...
							<div class="d-flex align-items-center justify-content-between publisher-footer side_item_list pb-0 flex-wrap">
								<div class="d-flex align-items-center publisher-tools-tabs">
									<?php if ($_smarty_tpl->getValue('system')['photos_enabled']) {?>
										<div class="publisher-tools-tab attach overflow-hidden js_publisher-tab main position-relative rounded-circle main_bg_half p-2 pointer" data-tab="photos" data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Upload Photos");?>
'>
										...
										<?php if (!$_smarty_tpl->getValue('_quick_mode')) {?>
											<div class="publisher-tools-tab js_publisher-tab main position-relative rounded-circle main_bg_half p-2 pointer" data-tab="album" data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Create Album");?>
'>
									...
									<?php if ($_smarty_tpl->getValue('user')->_data['can_upload_audios']) {?>
										<div class="publisher-tools-tab attach overflow-hidden js_publisher-tab main position-relative rounded-circle main_bg_half p-2 pointer" data-tab="audio" data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Upload Audio");?>
'>
									...
									<?php if ($_smarty_tpl->getValue('user')->_data['can_add_polls_posts']) {?>
										<div class="publisher-tools-tab js_publisher-tab main position-relative rounded-circle main_bg_half p-2 pointer" data-tab="poll" data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Create Poll");?>
'>
									...
									<?php if ($_smarty_tpl->getValue('user')->_data['can_upload_videos']) {?>
										<div class="publisher-tools-tab attach overflow-hidden js_publisher-tab main position-relative rounded-circle main_bg_half p-2 pointer" data-tab="video" data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Upload Video");?>
'>
									...
									<?php if ($_smarty_tpl->getValue('user')->_data['can_add_geolocation_posts']) {?>
										<div class="publisher-tools-tab js_publisher-tab main position-relative rounded-circle main_bg_half p-2 pointer" data-tab="location" data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Check In");?>
'>
...
">
									<?php }?>
									<button type="button" class="btn btn-main js_publisher-btn js_publisher"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Post");?>
</button>
								</div>
								<!-- publisher-buttons -->
							</div>
