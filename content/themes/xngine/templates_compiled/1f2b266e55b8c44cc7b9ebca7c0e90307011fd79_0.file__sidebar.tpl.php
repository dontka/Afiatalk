<?php
/* Smarty version 5.4.1, created on 2025-03-13 10:50:44
  from 'file:_sidebar.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67d2b884178ab1_82353868',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1f2b266e55b8c44cc7b9ebca7c0e90307011fd79' => 
    array (
      0 => '_sidebar.tpl',
      1 => 1741863010,
      2 => 'file',
...
function content_67d2b884178ab1_82353868 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\laragon\\www\\Script\\content\\themes\\xngine\\templates';
if ($_smarty_tpl->getValue('user')->_logged_in) {?>
	<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/saved" class="d-block py-1 body-color x_side_links x_hide_saved_link x_hide_mobi_side_link <?php if ($_smarty_tpl->getValue('page') == "index" && $_smarty_tpl->getValue('view') == "saved") {?>fw-semibold main<?php }?>">
		<div class="d-inline-flex align-items-center position-relative main_bg_half">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="27" height="27" color="currentColor" fill="none">
				<?php if ($_smarty_tpl->getValue('page') == "index" && $_smarty_tpl->getValue('view') == "saved") {?>
			...
			<span class="text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Saved Posts");?>
</span>
		</div>
	</a>
	...
	<?php if ($_smarty_tpl->getValue('system')['packages_enabled'] && !$_smarty_tpl->getValue('user')->_data['user_subscribed']) {?>
		<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/packages" class="d-block py-1 body-color x_side_links x_hide_pro_link x_hide_mobi_side_link <?php if ($_smarty_tpl->getValue('page') == "packages") {?>fw-semibold main<?php }?>">
			<div class="d-inline-flex align-items-center position-relative main_bg_half">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="27" height="27" color="currentColor" fill="none">
					<?php if ($_smarty_tpl->getValue('page') == "packages") {?>
				...
				<span class="text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Upgrade to Pro");?>
</span>
			</div>
		</a>
	<?php }?>
	...
	<?php if ($_smarty_tpl->getValue('system')['packages_enabled'] && $_smarty_tpl->getValue('user')->_data['user_subscribed']) {?>
		<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/boosted/posts" class="d-block py-1 body-color x_side_links x_hide_pro_link x_hide_mobi_side_link <?php if ($_smarty_tpl->getValue('page') == "index" && $_smarty_tpl->getValue('view') == "boosted_posts") {?>fw-semibold main<?php }?>">
			<div class="d-inline-flex align-items-center position-relative main_bg_half">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="27" height="27" color="currentColor" fill="none">
					<?php if ($_smarty_tpl->getValue('page') == "index" && $_smarty_tpl->getValue('view') == "boosted_posts") {?>
				...
				<span class="text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Boosted");?>
</span>
			</div>
		</a>
	<?php }?>
	...
	<?php if ($_smarty_tpl->getValue('system')['reels_enabled']) {?>
		<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/reels" class="d-block py-1 body-color x_side_links <?php if ($_smarty_tpl->getValue('page') == "reels") {?>fw-semibold main<?php }?>">
			<div class="d-inline-flex align-items-center position-relative main_bg_half">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="27" height="27" color="currentColor" fill="none">
				...
				<span class="text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Reels");?>
</span>
			</div>
		</a>
	<?php }
...
<?php if ($_smarty_tpl->getValue('system')['groups_enabled']) {?>
	<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/groups" class="d-block py-1 body-color x_side_links x_hide_groups_link x_hide_mobi_side_link <?php if ($_smarty_tpl->getValue('page') == "groups") {?>fw-semibold main<?php }?>">
		<div class="d-inline-flex align-items-center position-relative main_bg_half">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="27" height="27" color="currentColor" fill="none">
				<?php if ($_smarty_tpl->getValue('page') == "groups") {?>
			...
			<span class="text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Groups");?>
</span>
		</div>
	</a>
<?php }?>
...
<?php if ($_smarty_tpl->getValue('system')['pages_enabled']) {?>
	<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/pages" class="d-block py-1 body-color x_side_links x_hide_pages_link x_hide_mobi_side_link <?php if ($_smarty_tpl->getValue('page') == "pages") {?>fw-semibold main<?php }?>">
		<div class="d-inline-flex align-items-center position-relative main_bg_half">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="27" height="27" color="currentColor" fill="none">
				<?php if ($_smarty_tpl->getValue('page') == "pages") {?>
			...
			<span class="text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Pages");?>
</span>
		</div>
	</a>
<?php }?>
...
<?php if ($_smarty_tpl->getValue('system')['market_enabled']) {?>
	<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/market" class="d-block py-1 body-color x_side_links x_hide_market_link x_hide_mobi_side_link <?php if ($_smarty_tpl->getValue('page') == "market") {?>fw-semibold main<?php }?>">
		<div class="d-inline-flex align-items-center position-relative main_bg_half">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="27" height="27" color="currentColor" fill="none">
				<?php if ($_smarty_tpl->getValue('page') == "market") {?>
			...
			<span class="text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Marketplace");?>
</span>
		</div>
	</a>
<?php }?>
...
<div class="dropup">
	<a href="javascript:void(0);" class="d-block py-1 body-color x_side_links dropdownMoreMenuButton dropdownMenuButton" data-bs-toggle="dropdown">
		<div class="d-inline-flex align-items-center position-relative main_bg_half">
			...
			<span class="text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("See More");?>
</span>
		</div>
	</a>
	...
	<div class="dropdown-menu x_side_more_menu">
		<?php if ($_smarty_tpl->getValue('user')->_logged_in) {?>
			<a class='dropdown-item d-none x_show_saved_link <?php if ($_smarty_tpl->getValue('page') == "index" && $_smarty_tpl->getValue('view') == "saved") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/saved">
				...
				<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Saved Posts");?>

			</a>
		
			<?php if ($_smarty_tpl->getValue('system')['packages_enabled'] && !$_smarty_tpl->getValue('user')->_data['user_subscribed']) {?>
				<a class='dropdown-item d-none x_show_pro_link <?php if ($_smarty_tpl->getValue('page') == "packages") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/packages">
		...
		<?php if ($_smarty_tpl->getValue('system')['groups_enabled']) {?>
			<a class='dropdown-item d-none x_show_groups_link <?php if ($_smarty_tpl->getValue('page') == "groups") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/groups">
		...
		<?php }?>
		<?php if ($_smarty_tpl->getValue('system')['pages_enabled']) {?>
			<a class='dropdown-item d-none x_show_pages_link <?php if ($_smarty_tpl->getValue('page') == "pages") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/pages">
		...
		<?php }?>
		<?php if ($_smarty_tpl->getValue('system')['market_enabled']) {?>
			<a class='dropdown-item d-none x_show_market_link <?php if ($_smarty_tpl->getValue('page') == "market") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/market">
		...
		<?php if ($_smarty_tpl->getValue('user')->_data['can_write_blogs']) {?>
			<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "index" && $_smarty_tpl->getValue('view') == "blogs") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/my/blogs">
				...
				<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("My Blogs");?>

			</a>
		<?php }?>
		<?php if ($_smarty_tpl->getValue('user')->_data['can_sell_products']) {?>
			<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "index" && $_smarty_tpl->getValue('view') == "products") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/my/products">
				...
				<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("My Products");?>

			</a>
		<?php }?>
		<?php if ($_smarty_tpl->getValue('user')->_data['can_raise_funding']) {?>
			<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "index" && $_smarty_tpl->getValue('view') == "funding_requests") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/my/funding">
				...
				<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("My Funding");?>

			</a>
		<?php }?>
		<?php if ($_smarty_tpl->getValue('user')->_logged_in) {?>
			<?php if ($_smarty_tpl->getValue('system')['memories_enabled']) {?>
				<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "index" && $_smarty_tpl->getValue('view') == "memories") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/memories">
					...
					<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Memories");?>

				</a>
			<?php }?>
		
			<?php if ($_smarty_tpl->getValue('user')->_data['can_create_ads']) {?>
				<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "ads") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/ads">
					...
					<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Ads Manager");?>

				</a>
			<?php }?>
			<?php if ($_smarty_tpl->getValue('system')['packages_enabled']) {?>
				<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "index" && $_smarty_tpl->getValue('view') == "boosted_posts") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/boosted/posts">
		...
		<?php if ($_smarty_tpl->getValue('user')->_logged_in) {?>
			<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "people") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/people">
		...
		<?php if ($_smarty_tpl->getValue('system')['events_enabled']) {?>
			<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "events") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/events">
		...
		<?php if ($_smarty_tpl->getValue('user')->_logged_in) {?>
			<?php if ($_smarty_tpl->getValue('system')['watch_enabled']) {?>
				<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "index" && $_smarty_tpl->getValue('view') == "watch") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/watch">
					...
					<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Watch");?>
		...
		<?php if ($_smarty_tpl->getValue('system')['blogs_enabled']) {?>
			<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "blogs") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/blogs">
		...
		<?php if ($_smarty_tpl->getValue('system')['funding_enabled']) {?>
			<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "funding") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/funding">
		...
		<?php if ($_smarty_tpl->getValue('system')['offers_enabled']) {?>
			<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "offers") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/offers">
		...
		<?php if ($_smarty_tpl->getValue('system')['jobs_enabled']) {?>
			<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "jobs") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/jobs">
		...
		<?php if ($_smarty_tpl->getValue('system')['courses_enabled']) {?>
			<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "courses") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/courses">
		...
		<?php if ($_smarty_tpl->getValue('system')['forums_enabled']) {?>
			<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "forums") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/forums">
		...
		<?php if ($_smarty_tpl->getValue('system')['movies_enabled']) {?>
			<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "movies") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/movies">
		...
		<?php if ($_smarty_tpl->getValue('system')['games_enabled']) {?>
			<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "games") {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/games">
...
?>
				<?php if ($_smarty_tpl->getValue('static_page')['page_in_sidebar']) {?>
					<a class='dropdown-item <?php if ($_smarty_tpl->getValue('page') == "static_page" && $_smarty_tpl->getValue('static_page')['page_id'] == $_smarty_tpl->getValue('static_page_id')) {?>active <?php }?>' href="<?php echo $_smarty_tpl->getValue('static_page')['url'];?>
">
						<img width="20" height="20" class="flex-0" src="<?php echo $_smarty_tpl->getValue('static_page')['page_icon'];?>
">
