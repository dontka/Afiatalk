<?php
/* Smarty version 5.4.1, created on 2025-03-13 09:18:45
  from 'file:_sign_form.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67d2a2f51517a4_68877397',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5df6685de2cf29e3952bfa9da8377bb8977c8eb1' => 
    array (
      0 => '_sign_form.tpl',
      1 => 1733644220,
      2 => 'file',
  ...
  'includes' => 
  array (
    'file:__social_login.tpl' => 2,
    'file:__custom_fields.tpl' => 2,
  ),
))) {
function content_67d2a2f51517a4_68877397 (\Smarty\Template $_smarty_tpl) {
...
' required>
						<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" class="position-absolute"><path fill="currentColor" d="M798-120q-125 0-247-54.5T329-329Q229-429 174.5-551T120-798q0-18 12-30t30-12h162q14 0 25 9.5t13 22.5l26 140q2 16-1 27t-11 19l-97 98q20 37 47.5 71.5T387-386q31 31 65 57.5t72 48.5l94-94q9-9 23.5-13.5T670-390l138 28q14 4 23 14.5t9 23.5v162q0 18-12 30t-30 12ZM241-600l66-66-17-94h-89q5 41 14 81t26 79Zm358 358q39 17 79.5 27t81.5 13v-88l-94-19-67 67ZM241-600Zm358 358Z" /></svg>
					</div>
					<!-- phone -->
				<?php }?>
...
<?php } else { ?>
	...
	<div class="card-register bg-white rounded-3 mb-4">
		...
		<div class="position-relative overflow-hidden logo-wrapper text-center mb-4 pb-2">
			<!-- logo -->
			<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
" class="position-relative d-inline-block p-0 logo">
				<?php if ($_smarty_tpl->getValue('system')['system_logo']) {?>
					<img class="logo-light x_logo_pc" src="<?php echo $_smarty_tpl->getValue('system')['system_uploads'];?>
...
">
					<?php if (!$_smarty_tpl->getValue('system')['system_logo_dark']) {?>
						<img class="logo-dark x_logo_pc" src="<?php echo $_smarty_tpl->getValue('system')['system_uploads'];?>
/<?php echo $_smarty_tpl->getValue('system')['system_logo'];?>
" alt="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')($_smarty_tpl->getValue('system')['system_title']);?>
">
					<?php } else { ?>
...
">
					...
					<?php if ($_smarty_tpl->getValue('system')['system_favicon_default']) {?>
						<img class="x_logo_mobi" src="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/content/themes/<?php echo $_smarty_tpl->getValue('system')['theme'];?>
/images/favicon.png" alt="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')($_smarty_tpl->getValue('system')['system_title']);?>
"/>
					<?php } elseif ($_smarty_tpl->getValue('system')['system_favicon']) {?>
						<img class="x_logo_mobi" src="<?php echo $_smarty_tpl->getValue('system')['system_uploads'];?>
...
"/>
		...
		<div class="js_panel <?php if ($_smarty_tpl->getValue('do') == 'up') {?>x-hidden<?php }?>">
			<div class="card-header">
				<h4 class="card-title headline-font fw-bold mb-2"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Sign In to your Account");?>
</h4>
...
?>
 ...
 <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Username");?>
' name="username_email" required>
						<label><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Email");?>
 <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("or");?>
 <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Username");?>
</label>
					</div>
...
' name="password" required>
						<label><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Password");?>
</label>
					</div>
					<!-- password -->
					<!-- remember me -->
					<div class="d-flex align-items-center justify-content-between gap-2 flex-wrap">
						...
						<a class="" href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/reset"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Forgotten password?");?>
</a>
					</div>
					<!-- remember me -->
					<!-- submit -->
					<div class="mt-3">
						<button type="submit" class="btn btn-lg w-100 btn-primary"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Sign In");?>
</button>
					</div>
					<!-- submit -->
					<!-- error -->
 ...
 <a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/signup<?php if ($_smarty_tpl->getValue('oauth_app_id')) {?>?oauth_app_id=<?php echo $_smarty_tpl->getValue('oauth_app_id');
}?>" class="js_toggle-panel fw-medium"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Sign Up");?>
</a>
					</div>
				<?php }?>
			</div>
		...
		<div class="js_panel <?php if ($_smarty_tpl->getValue('do') != 'up') {?>x-hidden<?php }?>">
			<div class="card-header">
				<h4 class="card-title headline-font fw-bold mb-3"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Sign Up for an Account");?>
</h4>
			</div>
			<div class="card-body pt0">
				<form class="js_ajax-forms" data-url="core/signup.php" method="POST">
...
' value="<?php echo $_smarty_tpl->getValue('invitation_code');?>
" required>
							<label><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Invitation Code");?>
</label>
						</div>
						<!-- invitation code -->
					<?php }?>
...
' required>
							<label><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("First name");?>
</label>
						</div>
						<!-- first name -->
						<!-- last name -->
...
' required>
							<label><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Last name");?>
</label>
						</div>
						<!-- last name -->
					<?php }?>
...
' required>
						<label><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Username");?>
</label>
					</div>
					<!-- username -->
...
' required>
							<label><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Phone number (e.g: +1234567890)");?>
</label>
						</div>
						<!-- phone -->
					<?php }?>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
								...
								<label><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Select Sex");?>
</label>
							</div>
							<!-- genders -->
						<?php }?>
						...
						<?php if ($_smarty_tpl->getValue('system')['age_restriction']) {?>
							<!-- birthdate -->
							<div><label class="form-label"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Birthdate");?>
</label></div>
							<div class="row">
								<div class="col">
									<div class="form-floating">
										...
										<label><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Month");?>
</label>
									</div>
								</div>
								<div class="col">
...
?>
										...
										<label><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Day");?>
</label>
									</div>
								</div>
								<div class="col">
...
?>
										...
										<label><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Year");?>
</label>
									</div>
								</div>
							</div>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
								...
								<label><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Select User Group");?>
</label>
							</div>
							<!-- user group -->
						<?php }?>
...
">
						<?php }?>
						<button type="submit" class="btn btn-lg w-100 btn-primary"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Sign Up");?>
</button>
					</div>
					<!-- submit -->
				...
				<div class="mt-4">
					<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Already have an account?");?>
 <a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/signin" class="js_toggle-panel fw-medium"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Sign In");?>
</a>
				</div>
			</div>
		</div>
