<?php
/* Smarty version 5.4.1, created on 2025-03-13 07:47:59
  from 'file:_js_files.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67d28dafa0eb08_03726839',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '70632583008820305837ee6df5bbc018d01b1ea6' => 
    array (
      0 => '_js_files.tpl',
      1 => 1739089105,
      2 => 'file',
...
function content_67d28dafa0eb08_03726839 (\Smarty\Template $_smarty_tpl) {
...
><!-- Sticky Sidebar --><!-- Google Geocomplete --><?php if ($_smarty_tpl->getValue('system')['geolocation_enabled']) {
echo '<script'; ?>
...
echo '<script'; ?>
 type="text/javascript">
			function x_addSpecial(code, input) {
				tareaTag = $(input);
			...
			$(document).on('click','.x_menu_sidebar_back',function(){
				setTimeout(function() {
					$('body').addClass('show_menu_sidebar');
				}, 100);
				$('.x_menu_sidebar_content').fadeOut(100);
			});
			
			$(document).on('click','.x_menu_content_back',function(){
				$('body').removeClass('show_menu_sidebar');
				$('.x_menu_sidebar_content').fadeIn(100);
			});
			
			var didScroll;
			var lastScrollTop = 0;
			var delta = 5;
			var navbarHeight = $('.logo-wrapper').outerHeight();
			...
			$('body').on('click', '.js_live-requests, .js_live-messages', function () {
				var _this = $(this);
		...
		<?php echo '</script'; ?>
><?php }
if ($_smarty_tpl->getValue('page') == "admin") {?><!-- Dependencies Plugins --><?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
