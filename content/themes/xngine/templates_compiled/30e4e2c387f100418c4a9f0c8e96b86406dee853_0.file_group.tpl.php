<?php
/* Smarty version 5.4.1, created on 2025-03-13 09:34:43
  from 'file:group.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67d2a6b327e099_18331397',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '30e4e2c387f100418c4a9f0c8e96b86406dee853' => 
    array (
      0 => 'group.tpl',
      1 => 1736148971,
      2 => 'file',
...
function content_67d2a6b327e099_18331397 (\Smarty\Template $_smarty_tpl) {
					...
					<div class="profile-cover-buttons d-flex align-items-center gap-2 position-absolute m-2 m-md-3 top-0">
						<div class="profile-cover-change">
							...
							<div class="dropdown-menu action-dropdown-menu">
								<!-- upload -->
								<div class="dropdown-item pointer align-items-start js_x-uploader" data-handle="cover-group" data-id="<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
">
								...
								<!-- upload -->
								<!-- select -->
								<div class="dropdown-item pointer align-items-start" data-toggle="modal" data-url="users/photos.php?filter=cover&type=group&id=<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
">
						...
						<div class="profile-cover-position <?php if (!$_smarty_tpl->getValue('group')['group_cover']) {?>x-hidden<?php }?>">
							...
							<button type="button" class="btn bg-black text-white border-0 p-2 rounded-circle lh-1 flex-0 js_init-position-picture" data-handle="group" data-id="<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
">
						...
						<div class="profile-cover-delete <?php if (!$_smarty_tpl->getValue('group')['group_cover']) {?>x-hidden<?php }?>">
							<button type="button" class="btn bg-black text-white border-0 p-2 rounded-circle lh-1 flex-0 js_delete-cover" data-handle="cover-group" data-id="<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
">
			...
			<div Class="p-3 position-relative">
				...
				<div class="profile-avatar-wrapper rounded-3 bg-white p-1 position-relative mb-2">
					<img <?php if ($_smarty_tpl->getValue('group')['group_picture_id']) {?> class="js_lightbox pointer rounded-3" data-id="<?php echo $_smarty_tpl->getValue('group')['group_picture_id'];?>
" data-context="album" data-image="<?php echo $_smarty_tpl->getValue('group')['group_picture_full'];?>
" <?php } elseif (!$_smarty_tpl->getValue('group')['group_picture_default']) {?> class="js_lightbox-nodata rounded-3" data-image="<?php echo $_smarty_tpl->getValue('group')['group_picture'];?>
" <?php } else { ?> class="rounded-3"<?php }?> src="<?php echo $_smarty_tpl->getValue('group')['group_picture'];?>
" alt="<?php echo $_smarty_tpl->getValue('group')['group_title'];?>
">
					...
					<?php if ($_smarty_tpl->getValue('group')['i_admin']) {?>
						...
						<div class="profile-avatar-change position-absolute">
							...
							<div class="dropdown-menu action-dropdown-menu">
								<!-- upload -->
								<div class="dropdown-item pointer align-items-start js_x-uploader" data-handle="picture-group" data-id="<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
">
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="currentColor" fill="none"><path d="M13 3.00231C12.5299 3 12.0307 3 11.5 3C7.02166 3 4.78249 3 3.39124 4.39124C2 5.78249 2 8.02166 2 12.5C2 16.9783 2 19.2175 3.39124 20.6088C4.78249 22 7.02166 22 11.5 22C15.9783 22 18.2175 22 19.6088 20.6088C20.9472 19.2703 20.998 17.147 20.9999 13" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" /><path d="M2 14.1354C2.61902 14.0455 3.24484 14.0011 3.87171 14.0027C6.52365 13.9466 9.11064 14.7729 11.1711 16.3342C13.082 17.7821 14.4247 19.7749 15 22" stroke="currentColor" stroke-width="1.75" stroke-linejoin="round" /><path d="M21 16.8962C19.8246 16.3009 18.6088 15.9988 17.3862 16.0001C15.5345 15.9928 13.7015 16.6733 12 18" stroke="currentColor" stroke-width="1.75" stroke-linejoin="round" /><path d="M17 4.5C17.4915 3.9943 18.7998 2 19.5 2M22 4.5C21.5085 3.9943 20.2002 2 19.5 2M19.5 2V10" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" /></svg>
									<div class="action">
										<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Upload Photo");?>
								...
								<!-- upload -->
								<!-- select -->
								<div class="dropdown-item pointer align-items-start" data-toggle="modal" data-url="users/photos.php?filter=avatar&type=group&id=<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
">
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="currentColor" fill="none"><path d="M6 17.9745C6.1287 19.2829 6.41956 20.1636 7.07691 20.8209C8.25596 22 10.1536 22 13.9489 22C17.7442 22 19.6419 22 20.8209 20.8209C22 19.6419 22 17.7442 22 13.9489C22 10.1536 22 8.25596 20.8209 7.07691C20.1636 6.41956 19.2829 6.1287 17.9745 6" stroke="currentColor" stroke-width="1.75" /><path d="M2 10C2 6.22876 2 4.34315 3.17157 3.17157C4.34315 2 6.22876 2 10 2C13.7712 2 15.6569 2 16.8284 3.17157C18 4.34315 18 6.22876 18 10C18 13.7712 18 15.6569 16.8284 16.8284C15.6569 18 13.7712 18 10 18C6.22876 18 4.34315 18 3.17157 16.8284C2 15.6569 2 13.7712 2 10Z" stroke="currentColor" stroke-width="1.75" /><path d="M2 11.1185C2.61902 11.0398 3.24484 11.001 3.87171 11.0023C6.52365 10.9533 9.11064 11.6763 11.1711 13.0424C13.082 14.3094 14.4247 16.053 15 18" stroke="currentColor" stroke-width="1.75" stroke-linejoin="round" /><path d="M12.9998 7H13.0088" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg>
									<div class="action">
										<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Select Photo");?>
								...
								<!-- select -->
								<div class="<?php if ($_smarty_tpl->getValue('group')['group_picture_default']) {?>x-hidden<?php }?>">
									<div class="dropdown-divider"></div>
									<div class="dropdown-item pointer js_init-crop-picture" data-image="<?php echo $_smarty_tpl->getValue('group')['group_picture_full'];?>
...
">
									...
									<div class="dropdown-item pointer js_delete-picture" data-handle="picture-group" data-id="<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
">
...
" class="body-color h3 fw-bold m-0 align-middle"><?php echo $_smarty_tpl->getValue('group')['group_title'];?>
</a>
				</div>
				<!-- profile-name -->
				...
				<div class="mt-2">
					<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/groups/<?php echo $_smarty_tpl->getValue('group')['group_name'];?>
/members" class="body-color small">
						<span class="fw-semibold"><?php echo $_smarty_tpl->getValue('group')['group_members'];?>
</span>
						<span class="text-muted"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("members");?>
</span>
					</a>
				</div>
				...
				<div class="profile-buttons-wrapper position-absolute d-flex align-items-center gap-2 flex-wrap">
					...
					<?php if ($_smarty_tpl->getValue('group')['i_joined'] == "approved") {?>
						<button type="button" class="btn btn-success btn-delete js_leave-group" data-id="<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
" data-privacy="<?php echo $_smarty_tpl->getValue('group')['group_privacy'];?>
">
							<span class=""><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Joined");?>
</span>
						</button>
					<?php } elseif ($_smarty_tpl->getValue('group')['i_joined'] == "pending") {?>
						<button type="button" class="btn btn-warning js_leave-group" data-id="<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
" data-privacy="<?php echo $_smarty_tpl->getValue('group')['group_privacy'];?>
">
							<span class=""><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Pending");?>
</span>
						</button>
					<?php } else { ?>
						<button type="button" class="btn btn-success js_join-group" data-id="<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
" data-privacy="<?php if ($_smarty_tpl->getValue('group')['i_admin']) {?>public<?php } else {
echo $_smarty_tpl->getValue('group')['group_privacy'];
}?>">
							<span class=""><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Join");?>
</span>
						</button>
					<?php }?>
					<!-- join -->
					...
					<?php if ($_smarty_tpl->getValue('system')['groups_reviews_enabled']) {?>
						<?php if (!$_smarty_tpl->getValue('group')['i_admin']) {?>
							<button type="button" class="btn btn-gray" data-toggle="modal" data-url="modules/review.php?do=review&id=<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
&type=group">
								<span class=""><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Review");?>
</span>
							</button>
						<?php }?>
					<?php }?>
					...
					<div class="dropdown">
						...
						<div class="dropdown-menu dropdown-menu-end action-dropdown-menu">
							<!-- share -->
							<div class="dropdown-item pointer align-items-start" data-toggle="modal" data-url="modules/share.php?node_type=group&node_username=<?php echo $_smarty_tpl->getValue('group')['group_name'];?>
">
							...
							<?php if ($_smarty_tpl->getValue('user')->_logged_in) {?>
								<?php if (!$_smarty_tpl->getValue('group')['i_admin']) {?>
									<!-- report -->
									<div class="dropdown-item pointer align-items-start" data-toggle="modal" data-url="data/report.php?do=create&handle=group&id=<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
">
...
/products" class="body-color side_item_hover w-100 text-center d-block">
								<span class="position-relative d-inline-block py-3"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Store");?>
</span>
							</a>
						</div>
					<?php }?>
					<?php if ($_smarty_tpl->getValue('system')['groups_reviews_enabled']) {?>
						<div <?php if ($_smarty_tpl->getValue('view') == "reviews") {?>class="active fw-semibold" <?php }?>>
							<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/groups/<?php echo $_smarty_tpl->getValue('group')['group_name'];?>
/reviews" class="body-color side_item_hover w-100 text-center d-block">
								<span class="position-relative d-inline-block py-3"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Reviews");?>
</span>
							</a>
						</div>
					<?php }?>
					<div <?php if ($_smarty_tpl->getValue('view') == "members" || $_smarty_tpl->getValue('view') == "invites") {?>class="active fw-semibold" <?php }?>>
						<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/groups/<?php echo $_smarty_tpl->getValue('group')['group_name'];?>
/members" class="body-color side_item_hover w-100 text-center d-block">
							<span class="position-relative d-inline-block py-3"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Members");?>
</span>
						</a>
					</div>
				<?php }?>
			...
			<?php if ($_smarty_tpl->getValue('view') == '') {?>
				...
				<div class="col-lg-4 px-lg-3 py-3 order-2 js_sticky-sidebar">
					...
					<?php if ($_smarty_tpl->getValue('user')->_logged_in && !$_smarty_tpl->getValue('group')['i_admin'] && $_smarty_tpl->getValue('group')['has_subscriptions_plans']) {?>
						<button class="btn btn-primary mb-3 w-100" data-toggle="modal" data-url="monetization/controller.php?do=get_plans&node_id=<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
...
' autocomplete="off" <?php if ($_smarty_tpl->getValue('query')) {?>value="<?php echo $_smarty_tpl->getValue('query');?>
" <?php }?>>
					...
					<?php if ($_smarty_tpl->getValue('group')['i_joined'] == "approved" && $_smarty_tpl->getValue('group')['invites']) {?>
						<div class="mb-3 overflow-hidden content">
							<h6 class="headline-font fw-semibold m-0 side_widget_title">
								<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/groups/<?php echo $_smarty_tpl->getValue('group')['group_name'];?>
/invites" class="body-color"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Invite Friends");?>
</a>
							</h6>
							<ul>
								<?php
...
/settings/requests" class="alert-link">
											<?php echo $_smarty_tpl->getValue('group')['total_requests'];?>
 <?php if ($_smarty_tpl->getValue('group')['total_requests'] == 1) {
								...
								<div class="alert alert-secondary">
									<div class="text">
										<a href="?pending" class="alert-link">
											<?php if ($_smarty_tpl->getValue('group')['i_admin']) {?>
												<?php echo $_smarty_tpl->getValue('group')['pending_posts'];?>
 <?php if ($_smarty_tpl->getValue('group')['pending_posts'] == 1) {
...
?>
					<?php } else { ?>
						<div class="px-3 pb-3">
							<div class="d-flex align-items-center justify-content-between py-3 gap-10 border-0">
								<span class="headline-font fw-semibold side_widget_title p-0 flex-0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Store");?>
</span>
							</div>
...
?>
			...
			<?php } elseif ($_smarty_tpl->getValue('view') == "reviews") {?>
				...
				<div class="col-12 p-0">
					<div class="px-3 pb-3">
						<div class="d-flex align-items-center justify-content-between py-3 gap-10 border-0">
							<span class="headline-font fw-semibold side_widget_title p-0 flex-0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Reviews");?>
</span>
						</div>
						
						<div class="d-flex align-items-center flex-wrap justify-content-between p-3 gap-3 x_adslist">
							<div>
								<p class="mb-1 fw-medium"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Rating");?>
</p>
								<div class="d-flex gap-2">
									<h4 class="m-0 lh-1 mt-1"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('number_format')($_smarty_tpl->getValue('group')['group_rate'],1);?>
</h4>
								...
								<small class="text-muted"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Based on");?>
 <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')($_smarty_tpl->getValue('group')['reviews_count']);?>
 <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Reviews");?>
</small>
							</div>
							<?php if (!$_smarty_tpl->getValue('group')['i_admin']) {?>
								<button type="button" class="btn btn-primary" data-toggle="modal" data-url="modules/review.php?do=review&id=<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
&type=group"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Add");?>
 ...
 <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("doesn't have reviews");?>
			...
			<?php } elseif ($_smarty_tpl->getValue('view') == "members") {?>
				...
				<div class="col-12 p-0">
					<div class="px-3 pb-3">
						<div class="d-flex align-items-center justify-content-between py-3 gap-10 border-0">
							<span class="headline-font fw-semibold side_widget_title p-0 flex-0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Members");?>
</span>
							<div class="d-flex align-items-center flex-0 gap-10">
								<div class="dropdown">
									<button type="button" class="btn lh-1 p-2 px-3 btn-gray dropdown-toggle" data-bs-toggle="dropdown" data-display="static">
										<span class="btn-group-text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Members");?>
</span>
										<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.99977 9.00005L11.9998 15L17.9998 9" stroke="currentColor" stroke-width="1.75" stroke-miterlimit="16" stroke-linecap="round" stroke-linejoin="round"/></svg>
									</button>
									<div class="dropdown-menu dropdown-menu-end">
 ...
 <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("doesn't have subscribers");?>
			...
			<?php } elseif ($_smarty_tpl->getValue('view') == "invites") {?>
				...
				<div class="col-12 p-0">
					<div class="px-3 pb-3">
						<div class="d-flex align-items-center justify-content-between py-3 gap-10 border-0">
							<span class="headline-font fw-semibold side_widget_title p-0 flex-0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Invites");?>
</span>
							<div class="d-flex align-items-center flex-0 gap-10">
								<div class="dropdown">
									<button type="button" class="btn lh-1 p-2 px-3 btn-gray dropdown-toggle" data-bs-toggle="dropdown" data-display="static">
										<span class="btn-group-text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Invites");?>
</span>
										<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.99977 9.00005L11.9998 15L17.9998 9" stroke="currentColor" stroke-width="1.75" stroke-miterlimit="16" stroke-linecap="round" stroke-linejoin="round"/></svg>
									</button>
									<div class="dropdown-menu dropdown-menu-end">
						...
						<div class="x_menu_sidebar flex-0 no_hide">
							...
							<ul class="side-nav x_settings pb-3">
								<li <?php if ($_smarty_tpl->getValue('sub_view') == '') {?>class="active" <?php }?>>
									<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/groups/<?php echo $_smarty_tpl->getValue('group')['group_name'];?>
/settings" class="main_bg_half position-relative">
								...
								<?php if ($_smarty_tpl->getValue('group')['group_privacy'] != "public") {?>
									<li <?php if ($_smarty_tpl->getValue('sub_view') == "requests") {?>class="active" <?php }?>>
										<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/groups/<?php echo $_smarty_tpl->getValue('group')['group_name'];?>
/settings/requests" class="main_bg_half position-relative">
								...
								<li <?php if ($_smarty_tpl->getValue('sub_view') == "members") {?>class="active" <?php }?>>
									<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/groups/<?php echo $_smarty_tpl->getValue('group')['group_name'];?>
/settings/members" class="main_bg_half position-relative">
										<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Members");?>
								...
								<?php if ($_smarty_tpl->getValue('user')->_data['can_monetize_content']) {?>
									<li <?php if ($_smarty_tpl->getValue('sub_view') == "monetization") {?>class="active" <?php }?>>
										<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/groups/<?php echo $_smarty_tpl->getValue('group')['group_name'];?>
/settings/monetization" class="main_bg_half position-relative">
								...
								<?php if ($_smarty_tpl->getValue('user')->_data['user_id'] == $_smarty_tpl->getValue('group')['group_admin']) {?>
									<li <?php if ($_smarty_tpl->getValue('sub_view') == "delete") {?>class="active" <?php }?>>
										<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/groups/<?php echo $_smarty_tpl->getValue('group')['group_name'];?>
/settings/delete" class="main_bg_half position-relative">
						...
						<div class="x_menu_sidebar_content flex-1">
							<?php if ($_smarty_tpl->getValue('sub_view') == '') {?>
								...
								<form class="js_ajax-forms p-3 pt-1" data-url="modules/create.php?type=group&do=edit&edit=settings&id=<?php echo $_smarty_tpl->getValue('group')['group_id'];?>
">
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
									...
									<div class="form-floating">
										<textarea class="form-control" name="description" id="description" rows="4" placeholder=" "><?php echo $_smarty_tpl->getValue('group')['group_description'];?>
</textarea>
...
?>
									...
									<?php if ($_smarty_tpl->getValue('system')['chat_enabled']) {?>
										<div class="form-table-row mb-2 pb-1">
											<div>
											  <div class="form-label mb-0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Chat Box");?>
</div>
											  <div class="form-text d-none d-sm-block mt-0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Enable chat box for this group");?>
</div>
											</div>
									...
									<div class="form-table-row mb-2 pb-1">
										<div>
											<div class="form-label mb-0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Members Can Publish Posts?");?>
</div>
											<div class="form-text d-none d-sm-block mt-0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Members can publish posts or only group admins");?>
</div>
										</div>
										<div class="text-end align-self-center flex-0">
									...
									<div class="form-table-row mb-2 pb-1">
										<div>
											<div class="form-label mb-0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Post Approval");?>
</div>
...
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("or");?>
 ...
 <a class="alert-link" href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/wallet" target="_blank"> <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("wallet");?>
</a>
											<?php }?>
										</div>
									</div>
...
">
										<div class="form-table-row mb-2 pb-1">
											<div>
												<div class="form-label mb-0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Monetization");?>
</div>
												<div class="form-text d-none d-sm-block mt-0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Enable or disable monetization for your content");?>
</div>
											</div>
											<div class="text-end align-self-center flex-0">
...
&node_type=group" class="payment-plan new h-100 x_adslist pointer p-3">
													<div class="d-flex align-items-center justify-content-center w-100 h-100 flex-column gap-2 fw-medium">
														...
														<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Add new plan");?>
...
?>
												<div class="col-md-6 mb-4">
													<div class="payment-plan h-100 x_adslist p-3">
														<div class="h5 mb-1 fw-semibold"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')($_smarty_tpl->getValue('plan')['title']);?>
</div>
														<div class=""><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('plan')['price']);?>
...
if ($_prefixVariable1) {?>
															<div class="small"><?php echo $_smarty_tpl->getValue('plan')['custom_description'];?>
</div>
														<?php }?>
														<div class="d-flex align-items-center mt-3 gap-2">
															<button type="button" class="btn bg-white flex-1" data-toggle="modal" data-url="monetization/controller.php?do=edit&id=<?php echo $_smarty_tpl->getValue('plan')['plan_id'];?>
">
																<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="currentColor" fill="none"><path d="M16.9459 3.17305C17.5332 2.58578 17.8268 2.29215 18.1521 2.15173C18.6208 1.94942 19.1521 1.94942 19.6208 2.15173C19.946 2.29215 20.2397 2.58578 20.8269 3.17305C21.4142 3.76032 21.7079 4.05395 21.8483 4.37925C22.0506 4.8479 22.0506 5.37924 21.8483 5.84789C21.7079 6.17319 21.4142 6.46682 20.8269 7.05409L15.8054 12.0757C14.5682 13.3129 13.9496 13.9315 13.1748 14.298C12.4 14.6645 11.5294 14.7504 9.78823 14.9222L9 15L9.07778 14.2118C9.24958 12.4706 9.33549 11.6 9.70201 10.8252C10.0685 10.0504 10.6871 9.43183 11.9243 8.19464L16.9459 3.17305Z" stroke="currentColor" stroke-width="1.75" stroke-linejoin="round"></path><path d="M6 15H3.75C2.7835 15 2 15.7835 2 16.75C2 17.7165 2.7835 18.5 3.75 18.5H13.25C14.2165 18.5 15 19.2835 15 20.25C15 21.2165 14.2165 22 13.25 22H11" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"></path></svg> <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Edit");?>

															</button>
															<button type="button" class="btn bg-white flex-0 rounded-circle p-2 lh-1 js_monetization-deleter" data-id="<?php echo $_smarty_tpl->getValue('plan')['plan_id'];?>
" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Delete");?>
'>
									...
									<div class="row">
										...
										<div class="col-lg-6">
											<div class="stat-panel bg-info bg-opacity-10">
												<div class="stat-cell narrow">
													<div class=""><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Group Subscribers");?>
</div>
													<div class="h3 m-0 mt-2"><?php echo $_smarty_tpl->getValue('subscribers_count');?>
</div>
												</div>
											</div>
										</div>
										...
										<div class="col-lg-6">
											<div class="stat-panel bg-success bg-opacity-10">
												<div class="stat-cell narrow">
													<div class=""><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Monetization Money Balance");?>
</div>
													<div class="h3 m-0 mt-2"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getSmarty()->getModifierCallback('number_format')($_smarty_tpl->getValue('user')->_data['user_monetization_balance'],2));?>
</div>
												</div>
											</div>
										</div>
