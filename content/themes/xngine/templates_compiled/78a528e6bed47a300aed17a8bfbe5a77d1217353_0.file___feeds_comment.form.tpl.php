<?php
/* Smarty version 5.4.1, created on 2025-03-13 07:51:14
  from 'file:__feeds_comment.form.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67d28e726ae9b0_67215876',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '78a528e6bed47a300aed17a8bfbe5a77d1217353' => 
    array (
...
function content_67d28e726ae9b0_67215876 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\laragon\\www\\Script\\content\\themes\\xngine\\templates';
?><div class="comment border-0 p-0 writer js_comment-form <?php if ($_smarty_tpl->getValue('post')['comments_disabled']) {?>x-hidden<?php }?>" data-handle="<?php echo $_smarty_tpl->getValue('_handle');?>
	...
	<div class="d-flex x_user_info gap-2">
		<div class="comment-avatar flex-0">
			<?php if ($_smarty_tpl->getValue('post')['user_type'] == "page" && $_smarty_tpl->getValue('post')['is_page_admin']) {?>
				<a class="comment-avatar-picture rounded-circle overflow-hidden d-block" href="<?php echo $_smarty_tpl->getValue('post')['post_author_url'];?>
" style="background-image:url(<?php echo $_smarty_tpl->getValue('post')['post_author_picture'];?>
);"></a>
			<?php } else { ?>
				<a class="comment-avatar-picture rounded-circle overflow-hidden d-block" href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
...
" style="background-image:url(<?php echo $_smarty_tpl->getValue('user')->_data['user_picture'];?>
		...
		<div class="comment-data flex-1">
			<div class="x-form comment-form d-flex align-items-end gap-2">
				<textarea dir="auto" class="js_autosize js_mention js_post-comment bg-transparent px-0 w-100 m-0 py-2 border-0" rows="1" placeholder='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Write a comment");?>
'></textarea>
				<ul class="x-form-tools position-relative d-flex align-items-center flex-0 mb-2 gap-1">
					...
					<li class="x-form-tools-post js_post-comment">
						<button type="button" class="btn btn-sm btn-main"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Post");?>
</button>
					</li>
				</ul>
			</div>
...
<div class="text-center small fw-semibold text-muted opacity-75 js_comment-disabled-msg <?php if (!$_smarty_tpl->getValue('post')['comments_disabled']) {?>x-hidden<?php }?>">
