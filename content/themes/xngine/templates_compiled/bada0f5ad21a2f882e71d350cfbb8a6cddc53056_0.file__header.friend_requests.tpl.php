<?php
/* Smarty version 5.4.1, created on 2025-03-13 07:47:38
  from 'file:_header.friend_requests.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67d28d9a5393c1_54760583',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bada0f5ad21a2f882e71d350cfbb8a6cddc53056' => 
    array (
...
function content_67d28d9a5393c1_54760583 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\laragon\\www\\Script\\content\\themes\\xngine\\templates';
?><div class="dropend js_live-requests">
	<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/people/friend_requests" class="d-block py-1 body-color x_side_links <?php if ($_smarty_tpl->getValue('view') == "friend_requests") {?>fw-semibold main<?php }?>">
		<div class="d-inline-flex align-items-center position-relative main_bg_half">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="27" height="27" color="currentColor" fill="none">
				<?php if ($_smarty_tpl->getValue('view') == "friend_requests") {?>
			...
			<span class="counter rounded-pill position-absolute text-center pe-none <?php if ($_smarty_tpl->getValue('user')->_data['user_live_requests_counter'] == 0) {?>x-hidden<?php }?>">
				<?php echo $_smarty_tpl->getValue('user')->_data['user_live_requests_counter'];?>

			</span>
			<span class="text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Friend Requests");?>
</span>
		</div>
	</a>
