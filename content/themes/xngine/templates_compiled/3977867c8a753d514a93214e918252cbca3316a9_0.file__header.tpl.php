<?php
/* Smarty version 5.4.1, created on 2025-03-13 11:38:18
  from 'file:_header.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67d2c3aa16a982_24133121',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3977867c8a753d514a93214e918252cbca3316a9' => 
    array (
      0 => '_header.tpl',
      1 => 1741865893,
      2 => 'file',
...
function content_67d2c3aa16a982_24133121 (\Smarty\Template $_smarty_tpl) {
...
if (!$_smarty_tpl->getValue('system')['system_live']) {?> n_live<?php }?>" <?php if ($_smarty_tpl->getValue('page') == 'profile' && $_smarty_tpl->getValue('system')['system_profile_background_enabled'] && $_smarty_tpl->getValue('profile')['user_profile_background']) {?>style="background: url(<?php echo $_smarty_tpl->getValue('profile')['user_profile_background'];?>
 ...
 <span class="main fw-medium"><?php echo $_smarty_tpl->getValue('user')->_data['user_email'];?>
...
.
							...
							<div class="col-sm-5 text-md-end">
								...
								<?php } else { ?>
									<span class="btn btn-main btn-sm" data-toggle="modal" data-url="#activation-phone"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Enter Code");?>
</span>
			...
			<?php if ($_smarty_tpl->getValue('user')->_login_as) {?>
				...
				<div class="bottom-bar position-fixed">
					<div class="container rounded-4 text-white p-2 p-md-3 d-flex align-items-center gap-2 gap-md-3 logged-as-container">
						<span class="flex-0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("You are currently logged in as");?>
...
"><?php echo $_smarty_tpl->getValue('user')->_data['name'];?>
						...
						<button class="btn btn-sm btn-warning flex-0 js_login-as" data-handle="revoke">
							<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Switch Back");?>
			...
			<!-- container -->
			<div class="<?php if ($_smarty_tpl->getValue('page') != "app_oauth" && $_smarty_tpl->getValue('page') != "sign" && $_smarty_tpl->getValue('page') != "reset") {
if (!$_smarty_tpl->getValue('user')->_logged_in && !$_smarty_tpl->getValue('system')['newsfeed_public'] && $_smarty_tpl->getValue('page') == "index") {
} else {
if ($_smarty_tpl->getValue('system')['fluid_design']) {?>container-fluid x_cf_p<?php } else {
if ($_smarty_tpl->getValue('page') == "admin") {?>container-fluid x_cf_p<?php } else { ?>container<?php }
}
}
}?>">
				<!-- search-wrapper -->
				<?php if ($_smarty_tpl->getValue('page') != "app_oauth" && $_smarty_tpl->getValue('page') != "sign" && $_smarty_tpl->getValue('page') != "reset") {?>
					<?php if (!$_smarty_tpl->getValue('user')->_logged_in && !$_smarty_tpl->getValue('system')['newsfeed_public'] && $_smarty_tpl->getValue('page') == "index") {?>
					<?php } else { ?>
								...
								<div class="px-2 d-flex flex-column justify-content-between h-100 x-sidebar">
									<div class="position-relative main-header">
										...
										<div class="position-relative overflow-hidden logo-wrapper">
											<!-- logo -->
											<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
" class="position-relative d-inline-block main_bg_half logo">
...
"/>
										...
										<div class="x_sidebar_links">
											<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
" class="d-block py-1 body-color x_side_links <?php if ($_smarty_tpl->getValue('page') == "index" && $_smarty_tpl->getValue('view') == '') {?>fw-semibold main<?php }?>">
												<div class="d-inline-flex align-items-center position-relative main_bg_half">
													<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="27" height="27" color="currentColor" fill="none">
														<?php if ($_smarty_tpl->getValue('page') == "index" && $_smarty_tpl->getValue('view') == '') {?>
													...
													<span class="text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Home");?>
</span>
												</div>
											</a>
...
?>
											...
											<?php if ($_smarty_tpl->getValue('user')->_logged_in) {?>
												<?php if ($_smarty_tpl->getValue('user')->_data['can_publish_posts'] || $_smarty_tpl->getValue('user')->_data['can_go_live'] || $_smarty_tpl->getValue('user')->_data['can_add_stories'] || $_smarty_tpl->getValue('user')->_data['can_write_blogs'] || $_smarty_tpl->getValue('user')->_data['can_sell_products'] || $_smarty_tpl->getValue('user')->_data['can_raise_funding'] || $_smarty_tpl->getValue('user')->_data['can_create_ads'] || $_smarty_tpl->getValue('user')->_data['can_create_pages'] || $_smarty_tpl->getValue('user')->_data['can_create_groups'] || $_smarty_tpl->getValue('user')->_data['can_create_events']) {?>
													<!-- add -->
													<div class="dropup my-1 x_side_create">
														<a class="btn btn-main w-100 dropdownMenuButton" href="#" data-bs-toggle="dropdown">
															...
															<span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Create");?>
</span>
														</a>
...
/ads/new">
					...
					<!-- right column -->
					<div class="p-0 flex-0 <?php if ($_smarty_tpl->getValue('page') != "app_oauth" && $_smarty_tpl->getValue('page') != "sign" && $_smarty_tpl->getValue('page') != "reset") {
if (!$_smarty_tpl->getValue('user')->_logged_in && !$_smarty_tpl->getValue('system')['newsfeed_public'] && $_smarty_tpl->getValue('page') == "index") {
} else { ?>x-content-width<?php }
}?>">
						<!-- ads -->
