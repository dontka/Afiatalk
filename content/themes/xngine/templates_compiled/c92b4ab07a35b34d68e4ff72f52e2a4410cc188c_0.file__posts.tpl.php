<?php
/* Smarty version 5.4.1, created on 2025-03-13 07:50:14
  from 'file:_posts.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67d28e36068af2_23779690',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c92b4ab07a35b34d68e4ff72f52e2a4410cc188c' => 
    array (
      0 => '_posts.tpl',
      1 => 1735564614,
      2 => 'file',
...
function content_67d28e36068af2_23779690 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\laragon\\www\\Script\\content\\themes\\xngine\\templates';
?><!-- posts-filter -->
<?php if ($_smarty_tpl->getValue('_filter') == "article") {?>
	<?php if ($_smarty_tpl->getValue('user')->_data['can_write_blogs']) {?>
		<div class="d-flex align-items-center p-3 position-sticky x_top_posts">
			<div class="d-flex align-items-center justify-content-between gap-10 position-relative flex-wrap">
				<span class="headline-font fw-semibold side_widget_title p-0 flex-0"><?php if ($_smarty_tpl->getValue('_title')) {
...
/blogs/new" class="btn btn-sm btn-primary flex-0 d-none d-md-flex">
						<span class="my2"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Create Blog");?>
</span>
					</a>
					<a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/blogs/new" class="btn btn-primary flex-0 p-2 rounded-circle lh-1 d-md-none">
	...
	<?php }
} elseif ($_smarty_tpl->getValue('_filter') == "product" && !$_smarty_tpl->getValue('_query')) {?>
...
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Recent Updates");
				...
				<span class="flex-0">
					<a href="javascript:void(0);" class="btn btn-sm btn-primary flex-0 d-none d-md-flex" data-toggle="modal" data-url="posts/product.php?do=create">
						<span class="my2"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Create Product");?>
</span>
					</a>
	...
	<?php }
} elseif ($_smarty_tpl->getValue('_filter') == "funding") {?>
...
echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Recent Updates");
				...
				<span class="flex-0">
					<a href="javascript:void(0);" class="btn btn-sm btn-primary flex-0 d-none d-md-flex" data-toggle="modal" data-url="posts/funding.php?do=create">
						<span class="my2"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Create Funding");?>
</span>
					</a>
