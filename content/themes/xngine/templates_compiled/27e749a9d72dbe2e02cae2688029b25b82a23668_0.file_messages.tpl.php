<?php
/* Smarty version 5.4.1, created on 2025-03-13 08:12:21
  from 'file:messages.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67d2936568a556_49017601',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '27e749a9d72dbe2e02cae2688029b25b82a23668' => 
    array (
      0 => 'messages.tpl',
      1 => 1737270349,
      2 => 'file',
...
function content_67d2936568a556_49017601 (\Smarty\Template $_smarty_tpl) {
...
<div class="w-100 overflow-hidden d-flex bg-white">
	<!-- threads -->
	<div class="x_menu_sidebar d-flex flex-column flex-0 msg">
		<div class="d-flex align-items-center justify-content-between gap-2 p-2 flex-0 w-100">
            ...
            <div class="flex-0 m-1">
				<a class="btn btn-gray border-0 p-2 rounded-circle lh-1 js_chat-new" href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/messages/new">
			...
			<div class="panel-messages d-flex flex-column h-100 fresh">
				...
				<div class="card-body flex-1 mh-0 d-flex flex-column position-relative">
					...
					<div class="chat-to px-2 gap-2 position-absolute bg-white d-flex align-items-start js_autocomplete-tags">
						<div class="to flex-0 py-1 small"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("To");?>
:</div>
 ...
 <span class="js_voice-timer">00:00</span>
					...
					<div class="x-form flex-0 chat-form p-2 bg-white">
						<div class="chat-form-message">
							<textarea class="pt-2 px-3 w-100 m-0 shadow-none border-0 d-block js_autosize js_post-message" dir="auto" rows="1" placeholder='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Write a message");?>
'></textarea>
						</div>
					...
					<div class="text-muted text-center p-3">
						...
						<div class="text-md mt-4">
							<h5 class="headline-font m-0">
								<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("No Conversation Selected");?>

							</h5>
						</div>
						<a class="mt-3 btn btn-main js_chat-new" href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/messages/new">
							<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("New Message");?>
