			...
			<div class="p-3 position-relative">
				...
				<div class="d-flex align-items-center gap-3 mt-2 text-muted w-100">
                    ...
                    <div class="d-flex align-items-center gap-1 flex-0">
						...
						{__($profile['posts_count'])} <span class="d-none d-md-inline-block">{__("Posts")}</span>
                    </div>
					<!-- posts -->
					<!-- photos -->
                    <div class="d-flex align-items-center gap-1 flex-0">
						...
						{__($profile['photos_count'])} <span class="d-none d-md-inline-block">{__("Photos")}</span>
                    </div>
					<!-- photos -->
					{if $system['videos_enabled']}
						...
						<div class="d-flex align-items-center gap-1 flex-0">
							...
							{__($profile['videos_count'])} <span class="d-none d-md-inline-block">{__("Videos")}</span>
						</div>
						<!-- videos -->
					{/if}
				</div>
		...
		<div class="position-sticky x_top_posts profile-tabs-wrapper">
			<div class="d-flex align-items-center justify-content-center">
				...
				{if $system['pages_enabled']}
					<div {if $view == "likes"}class="active fw-semibold" {/if}>
						<a href="{$system['system_url']}/{$profile['user_name']}/likes" class="body-color side_item_hover w-100 text-center d-block">
							<span class="position-relative d-inline-block py-3">{__("Likes")}</span>
						</a>
					</div>
				{/if}
				...
				<div class="col-12 p-0">
					<div class="pb-3">
						<div class="d-flex align-items-center justify-content-between p-3 gap-10 border-0">
							<span class="headline-font fw-semibold side_widget_title p-0 flex-0">{__("Likes")}</span>
						</div>
