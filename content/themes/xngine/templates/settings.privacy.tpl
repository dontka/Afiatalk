...
<form class="js_ajax-forms p-3 pt-1" data-url="users/settings.php?edit=privacy">
    {if $system['chat_enabled']}
		<div class="form-table-row mb-2 pb-1">
			<div>
				<div class="form-label mb0">{__("Chat Enabled")}</div>
				<div class="form-text d-none d-sm-block mt0">{__("If chat disabled you will appear offline and will not see who is online")}</div>
			</div>
