	...
	<div class="col-lg-12 w-100">
		<div class="p-3">
			...
			<div class="js_wizard-content" id="step-1">
				...
				<p class="">{__("Welcome")} <span class="fw-medium">{$user->_data['name']}</span>, {__("Let's start with your photo")}</p>
				...
				<!-- buttons -->
				<div class="text-end">
					<button id="activate-step-2" class="btn btn-primary">{__("Next Step")}</button>
				</div>
				<!-- buttons -->
			</div>
