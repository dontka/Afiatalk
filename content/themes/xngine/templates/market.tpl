					...
					{if in_array($view, ['', 'search', 'category'])}
						{if $rows}
							...
							<div class="dropdown-menu dropdown-menu-end">
								<a href="?{if $distance}distance={$distance}&{/if}sort=latest" class='dropdown-item {if !$sort || $sort == "latest"}active{/if}'>
									{__("Latest")}
								</a>
								<a href="?{if $distance}distance={$distance}&{/if}sort=price-high" class='dropdown-item {if $sort == "price-high"}active{/if}'>
									{__("Price High")}
								</a>
								<a href="?{if $distance}distance={$distance}&{/if}sort=price-low" class='dropdown-item {if $sort == "price-low"}active{/if}'>
									{__("Price Low")}
								</a>
							</div>
							<!-- sort -->
