{if $get == 'newsfeed' || $get == 'posts_profile' || $get == 'posts_page' || $get == 'posts_group' || $get == 'posts_group_pending' || $get == 'posts_group_pending_all' || $get == 'posts_event' || $get == 'posts_event_pending' || $get == 'posts_event_pending_all' || $get == 'saved' || $get == 'memories' || $get == 'boosted' || $get == 'popular' || $get == 'discover' || $get == 'watch'}
  ...
  {if $get == 'newsfeed'}
    <!-- suggested reels -->
    {if $reels}
		<div class="content rounded-0 border-top-0 border-start-0 border-end-0">
			<h6 class="headline-font fw-semibold m-0 side_widget_title">
				{__("Reels")}
			</h6>
			<div class="reels-box-wrapper">
...
{elseif $get == 'page_activities'}
  {foreach $data as $activity}
    {include file='__feeds_activity.tpl'}
  {/foreach}


{elseif $get == 'page_activities_users' || $get == 'page_activities_permission_requests'}
  {foreach $data as $_user}
    {include file='__feeds_user.tpl' _tpl="list" _connection=$_user["connection"]}
  {/foreach}
