		...
		<div class="d-flex align-items-center justify-content-between x_user_info {if $_small}small{/if}">
			...
			{if !$_prusrs == "pro"}
				<div class="flex-0">
					...
					{elseif $_connection == "page_activities_request"}
						<button type="button" class="btn btn-sm btn-danger js_activities-permission-decline" data-id="{$_user['request_id']}">
						  {__("Decline")}
						</button>
						<button type="button" class="btn btn-sm btn-main js_activities-permission-accept" data-id="{$_user['request_id']}" data-permission="editor">
						  {__("Approve Editor")}
						</button>
						<button type="button" class="btn btn-sm btn-main js_activities-permission-accept" data-id="{$_user['request_id']}" data-permission="viewer">
						  {__("Approve Viewer")}
						</button>

					{elseif $_connection == "page_activities_manage"}
						<button type="button" class="btn btn-sm btn-danger js_activities-permission-revoke" data-id="{$_user['user_id']}">
