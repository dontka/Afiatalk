		...
		<div class="flex-0 m-1 d-flex align-items-center gap-2">
			{if !$conversation['multiple_recipients'] && !$conversation['node_id']}
				{if $system['video_call_enabled']}
					<button type="button" class="btn btn-gray border-0 p-2 rounded-circle lh-1 js_chat-call-start" data-type="video" data-uid="{$conversation['user_id']}" data-name="{$conversation['name']}">
				...
				{if $system['audio_call_enabled']}
					<button type="button" class="btn btn-gray border-0 p-2 rounded-circle lh-1 js_chat-call-start" data-type="audio" data-uid="{$conversation['user_id']}" data-name="{$conversation['name']}">
