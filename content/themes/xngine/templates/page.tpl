			...
			<div Class="p-3 position-relative">
				...
				<div class="d-flex align-items-center gap-3 mt-2 text-muted">
                    ...
                    <div class="d-flex align-items-center gap-1">
						...
						{__($spage['posts_count'])} <span class="d-none d-md-inline-block">{__("Posts")}</span>
                    </div>
					<!-- posts -->
					<!-- photos -->
                    <div class="d-flex align-items-center gap-1">
						...
						{__($spage['photos_count'])} <span class="d-none d-md-inline-block">{__("Photos")}</span>
                    </div>
					<!-- photos -->
					{if $system['videos_enabled']}
						...
						<div class="d-flex align-items-center gap-1">
							...
							{__($spage['videos_count'])} <span class="d-none d-md-inline-block">{__("Videos")}</span>
						</div>
						<!-- videos -->
					{/if}
		...
		<div class="position-sticky x_top_posts profile-tabs-wrapper">
			<div class="d-flex align-items-center justify-content-center">
				...
				{if $system['pages_activities_enabled'] && $spage['page_activities_enabled']}
					<div {if $view == "activities"}class="active fw-semibold" {/if}>
						<a href="{$system['system_url']}/pages/{$spage['page_name']}/activities" class="body-color side_item_hover w-100 text-center d-block">
							<span class="position-relative d-inline-block py-3">{__("Activities")}</span>
						</a>
					</div>
				{/if}
				{if $spage['i_like']}
		...
		<div class="row x_content_row">
			...
			{elseif $view == "activities"}
				...
				<div class="col-12 p-0">
					<div class="px-3 pb-3">
						<div class="d-flex align-items-center justify-content-between py-3 gap-10 border-0">
							<span class="headline-font fw-semibold side_widget_title p-0 flex-0">{__("Activities")}</span>
							{if $spage['activities_permission'] == "editor"}
								<div class="flex-0">
									<button type="button" class="btn lh-1 p-2 px-3 btn-main" data-toggle="modal" data-url="modules/activities.php?do=add&id={$spage['page_id']}">
										{__("Create")}
									</button>
								</div>
							{/if}
						...
						{else}
							...
							{if $case == "pending"}
								<div class="text-muted text-center py-5">
									...
									<div class="post-paid-description mt-2">
										{__("Your request is still awaiting admin approval")}
									</div>
								</div>
							{elseif $case == "declined"}
								<div class="text-muted text-center py-5">
									...
									<div class="post-paid-description mt-2">
										{__("Your request has been declined by the admin")}
									</div>
								</div>
							{else}
								<!-- request permission -->
								<div class="">
									<button class="btn btn-primary js_activities-permission-request" data-id="{$spage['page_id']}">
							...
							<ul class="side-nav x_settings pb-3">
								...
								{if $system['pages_activities_enabled'] && $spage['page_activities_enabled']}
									<li {if $sub_view == "activities"}class="active" {/if}>
										<a href="{$system['system_url']}/pages/{$spage['page_name']}/settings/activities" class="main_bg_half position-relative">
											{__("Activities")}
										</a>
									</li>
								{/if}
							...
							{if $sub_view == ""}
								...
								<form class="js_ajax-forms p-3 pt-1" data-url="modules/create.php?type=page&do=edit&edit=settings&id={$spage['page_id']}">
									...
									{if $system['pages_activities_enabled']}
										{if !$user->_data['can_receive_tip']}<hr>{/if}
										<div class="form-table-row mb-2 pb-1">
											<div>
												<div class="form-label mb0">{__("Activities Enabled")}</div>
												<div class="form-text d-none d-sm-block mt0">{__("Allow the activities on your page")}</div>
											</div>
											<div class="text-end align-self-center flex-0">
